...
<div class="container my-5">
    <div class="row">
        <h1 class="text-center my-5 fw-bold text-primary">Lập thời khóa biểu</h1>
        <div class="d-flex justify-content-center">
            <form class="w-100 w-md-75 w-lg-50 p-4 rounded shadow bg-white" method="POST" action="{{ route('saveSchedule') }}" onsubmit="return validateForm()">
                @csrf
                <div class="mb-3">
...
<div class="container my-5">
    <div class="row text-center">
        <h2 class="mb-4 fw-bold text-secondary">Các thời khóa biểu đã lập</h2>
        <div class="list-group">
            @foreach ($tkbs as $tkb)
                <a href="{{ route('schedule',  $tkb->TenTKB) }}" class="list-group-item list-group-item-action fs-5">
                    {{ $tkb->TenTKB }}
                </a>
            @endforeach
        </div>
