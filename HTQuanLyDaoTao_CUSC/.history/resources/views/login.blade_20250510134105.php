                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form action="{{ route('ldap') }}" method="POST" class="needs-validation"
                                    novalidate="">
                                    @csrf
                                    ...
                                    <div class="form-group text-center mb-3">
                                        ...
                                        <input type="text" class="form-control mt-2" name="captcha" id="InputCaptcha"
                                    ...
                                    <div class="d-grid">
                                        <button id="toastr-4 submit-button" type="submit"
