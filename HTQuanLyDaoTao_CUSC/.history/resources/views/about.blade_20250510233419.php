...
<div class="container-fluid p-0" style="height: 57rem">
    <div id="carouselSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-touch="true">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{ asset('storage/slider_CUSC/banner1.jpg') }}" class="d-block w-100" alt="banner1">
          </div>
          <div class="carousel-item">
            <img src="{{ asset('storage/Slider_CUSC/banner2.jpg') }}" class="d-block w-100" alt="banner2">
          </div>
        </div>
      </div>
</div>
