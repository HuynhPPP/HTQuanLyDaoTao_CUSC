<footer class="footer bg-dark text-white py-5">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="text-center mb-4">
                    ...
                    <h5 class="fw-bold mb-3">TRUNG TÂM CÔNG NGHỆ PHẦN MỀM<br>ĐẠI HỌC CẦN THƠ</h5>
                </div>
            </div>
        ...
        <!-- Copyright và Social Media -->
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <p class="mb-0">© {{ date('Y') }} Trung tâm Công nghệ phần mềm Đại học Cần Thơ</p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <a href="https://www.youtube.com/c/CUSCAPTECHCHANNEL" class="btn btn-outline-light btn-floating m-1" target="_blank">
                    <i class="fab fa-youtube"></i>
                </a>
                <a href="https://www.facebook.com/CUSC.CE/" class="btn btn-outline-light btn-floating m-1" target="_blank">
                    <i class="fab fa-facebook"></i>
                </a>
                <a href="https://www.instagram.com/arena.cantho/" class="btn btn-outline-light btn-floating m-1" target="_blank">
                    <i class="fab fa-instagram"></i>
                </a>
                <a href="#" class="btn btn-outline-light btn-floating m-1" data-bs-toggle="modal" data-bs-target="#zalo__modal">
...
/* Đảm bảo nội dung chính lấp đầy không gian còn lại */
main {
    flex: 1 0 auto;
}
</style>