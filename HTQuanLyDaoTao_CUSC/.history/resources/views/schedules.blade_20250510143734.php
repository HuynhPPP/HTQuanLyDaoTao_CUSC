                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('saveSchedule') }}" onsubmit="return validateForm()">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="KhoaDaoTao" class="form-select @error('KhoaDaoTao') is-invalid @enderror"
                                    name="KhoaDaoTao">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="ChuongTrinhTrienKhai"
                                    class="form-select @error('ChuongTrinhTrienKhai') is-invalid @enderror"
                            ...
                            <div class="mb-3">
                                ...
                                <select id="Lop" class="form-select @error('Lop') is-invalid @enderror"
                                    name="Lop">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="HocKi" class="form-select @error('HocKi') is-invalid @enderror"
                                    name="HocKi">
