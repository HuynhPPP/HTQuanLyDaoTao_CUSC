...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::get('/schedule/{TenTKB}', [PagesController::class, 'schedule'])->name('view.schedule');
    ...
    Route::prefix('bao-cao')->name('bao-cao.')->group(function () {
        Route::get('/upload', [ThongKeBaoCaoDoAnController::class, 'uploadForm'])->name('upload.form');
        Route::post('/upload', [ThongKeBaoCaoDoAnController::class, 'upload'])->name('upload');

        Route::get('/', [ThongKeBaoCaoDoAnController::class, 'index'])->name('index');
        Route::get('/edit/{id}', [ThongKeBaoCaoDoAnController::class, 'edit'])->name('edit');
        Route::post('/update/{id}', [ThongKeBaoCaoDoAnController::class, 'update'])->name('update');

        Route::get('/export', [ThongKeBaoCaoDoAnController::class, 'exportExcel'])->name('export');
        Route::post('/debug-parse', [ThongKeBaoCaoDoAnController::class, 'debugParse'])->name('debugParse');
    });
});
