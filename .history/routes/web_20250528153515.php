...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('schedules')->group(function () {
        Route::get('/', [PagesController::class, 'schedules'])->name('schedules');
        Route::post('/save', [PagesController::class, 'saveSchedule'])->name('saveSchedule');
        Route::get('/schedule/{TenTKB}', [PagesController::class, 'schedule'])->name('schedule');
        Route::delete('/schedule/{TenTKB}', [PagesController::class, 'deleteSchedule'])->name('deleteSchedule');
        Route::get('/export-excel/{TenTKB}', [PagesController::class, 'exportExcel'])->name('exportExcel');
    });
    ...
    // Quản lý tài khoản AD
    Route::prefix('ad-accounts')->group(function () {
        Route::get('/', [ADAccountController::class, 'index'])->name('ad-accounts.index');
        Route::get('/create', [ADAccountController::class, 'create'])->name('ad-accounts.create');
        Route::post('/store', [ADAccountController::class, 'store'])->name('ad-accounts.store');
        Route::get('/{username}', [ADAccountController::class, 'show'])->name('ad-accounts.show');
        Route::get('/{username}/edit', [ADAccountController::class, 'edit'])->name('ad-accounts.edit');
        Route::post('/{username}/update', [ADAccountController::class, 'update'])->name('ad-accounts.update');
        Route::delete('/{username}', [ADAccountController::class, 'destroy'])->name('ad-accounts.destroy');
        Route::post('/{username}/reset-password', [ADAccountController::class, 'resetPassword'])->name('ad-accounts.reset-password');
        Route::post('/{username}/toggle', [ADAccountController::class, 'toggleAccount'])->name('ad-accounts.toggle');
        Route::post('/sync', [ADAccountController::class, 'syncFromAD'])->name('ad-accounts.sync');
...
Route::middleware([RoleMiddleware::class . ':admin,staff,teacher'])->group(function () {
    ...
    Route::prefix('tochucthi')->group(function () {
        ...
        Route::get('/bangdiem/nhap-diem', [BangDiemController::class, 'nhapDiemChoLop'])->name('bangdiem.nhap-diem');
        Route::post('/bangdiem/luu-diem-lop', [BangDiemController::class, 'luuDiemChoLop'])->name('bangdiem.luu-diem-lop');
    });
});
