...
Route::prefix('sinh-vien-du-thi')->group(function () {
    Route::get('/danh-sach/{maLichThi}', [SinhVienDuThiController::class, 'danhSachSinhVienDuThi'])
        ->name('sinhvien.duthi.danh-sach');
    Route::post('/luu', [SinhVienDuThiController::class, 'luuDanhSachDuThi'])
        ->name('sinhvien.duthi.luu');
    Route::get('/xuat-excel/{maLichThi}', [SinhVienDuThiController::class, 'xuatExcel'])
        ->name('sinhvien.duthi.xuat-excel');
    Route::get('/xuat-bang-diem/{maLichThi}', [SinhVienDuThiController::class, 'xuatBangDiem'])
        ->name('sinhvien.duthi.xuat-bang-diem');
});
