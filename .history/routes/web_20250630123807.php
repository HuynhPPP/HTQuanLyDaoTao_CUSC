...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('thong-ke')->name('thong-ke.')->group(function () {
        Route::get('/sinh-vien', [ThongKeController::class, 'thongKeSinhVien'])->name('sinh-vien');
        Route::get('/diem-so', [ThongKeController::class, 'thongKeDiem'])->name('diem-so');
        Route::get('/hoc-luc', [ThongKeController::class, 'phanLoaiHocLuc'])->name('hoc-luc');
        Route::get('/khoa-hoc', [ThongKeController::class, 'thongKeKhoaHoc'])->name('khoa-hoc');
        // Thống kê dashboard
        Route::get('/thong-ke-dashboard', [ThongKeDashboardController::class, 'index'])
            ->name('dashboard');
        Route::get('/hoc-tap/{maChuongTrinh}', 
            [ThongKeHocTapController::class, 'baoCaoChiTiet'])
            ->name('thong-ke.hoc-tap');
        
        Route::get('/xuat-bao-cao/{maChuongTrinh}', 
