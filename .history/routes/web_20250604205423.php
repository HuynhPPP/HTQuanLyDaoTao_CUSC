...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('monhoc')->group(function () {
        ...
        Route::get('/mon-hoc/phan-cong-giang-vien/{tenMH}', [MonHocController::class, 'addTeacherForm'])->name('monhoc.add-teacher');
        Route::post('/mon-hoc/phan-cong-giang-vien/{tenMH}', [MonHocController::class, 'storeTeacher'])->name('monhoc.store-teacher');
        // Xoá giảng viên khỏi môn học
Route::delete('/mon-hoc/{tenMH}/remove-teacher/{maGV}', [MonHocController::class, 'removeTeacher'])
->name('monhoc.remove-teacher');

// Chỉnh sửa phân công giảng viên
Route::get('/mon-hoc/{tenMH}/edit-teacher/{maGV}', [MonHocController::class, 'editTeacherAssignment'])
->name('monhoc.edit-teacher');
Route::put('/mon-hoc/{tenMH}/update-teacher/{maGV}', [MonHocController::class, 'updateTeacherAssignment'])
