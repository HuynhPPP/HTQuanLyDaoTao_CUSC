...
Route::middleware([RoleMiddleware::class . ':teacher'])->group(function () {
    ...
    Route::prefix('giao-vien/lich-thi')->group(function () {
        Route::get('/', [App\Http\Controllers\GiaoVien\LichCoiThiController::class, 'index'])
            ->name('giaovien.lichthi.index');
        Route::get('/{maLichThi}', [App\Http\Controllers\GiaoVien\LichCoiThiController::class, 'chiTietLichThi'])
            ->name('giaovien.lichthi.chi-tiet');
    });

    // Nhập điểm thi
    Route::prefix('giao-vien/nhap-diem-thi')->group(function () {
        Route::get('/', [App\Http\Controllers\GiaoVien\NhapDiemController::class, 'danhSachLopDay'])
            ->name('giaovien.nhapdiemthi.danh-sach-mon');
        Route::get('/mon-hoc/{tenMH}', [App\Http\Controllers\GiaoVien\NhapDiemController::class, 'danhSachLichThi'])
            ->name('giaovien.nhapdiemthi.danh-sach-lichthi');
        Route::get('/{maLichThi}', [App\Http\Controllers\GiaoVien\NhapDiemController::class, 'nhapDiem'])
            ->name('giaovien.nhapdiemthi.nhap-diem');
        Route::post('/{maLichThi}', [App\Http\Controllers\GiaoVien\NhapDiemController::class, 'luuDiem'])
