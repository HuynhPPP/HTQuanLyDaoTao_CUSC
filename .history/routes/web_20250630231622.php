...
use App\Http\Controllers\ThongKeDashboardController;
...
use App\Http\Controllers\HinhThucDanhGiaController;
use App\Http\Controllers\TieuChiXepLoaiController;
...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('chuongtrinh')->group(function () {
        ...
        Route::post('/hinh-thuc-danh-gia/xoa/{id}', [ChuongTrinhDaoTaoController::class, 'xoaHinhThucDanhGia'])->name('chuongtrinh.xoa.hinhthucdanhgia');
    ...
    Route::prefix('thong-ke')->name('thong-ke.')->group(function () {
        ...
        Route::get('/thong-ke-dashboard', [ThongKeDashboardController::class, 'index'])
            ->name('dashboard');
        Route::get('/chon-chuong-trinh-thong-ke-hoc-tap', [ThongKeHocTapController::class, 'chonChuongTrinh'])->name('chon-chuong-trinh-thong-ke-hoc-tap');
        Route::get(
            '/hoc-tap/{maChuongTrinh}',
            [ThongKeHocTapController::class, 'baoCaoChiTiet']
        )
            ->name('thong-ke-hoc-tap');

        Route::get(
            '/xuat-bao-cao/{maChuongTrinh}',
            [ThongKeHocTapController::class, 'xuatBaoCao']
        )
            ->name('thong-ke.xuat-bao-cao');
    });
});
