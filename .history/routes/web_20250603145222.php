...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('giaovien')->group(function () {
        ...
        Route::get('/dong-bo-tai-khoan-ldap', [GiaoVienController::class, 'dongBoTaiKhoanGVLDAP'])
            ->name('giaovien.dongbo.taikhoan.ldap');

        Route::get('/kiem-tra-dong-bo-ldap', [GiaoVienController::class, 'kiemTraDongBoGVLDAP'])
