...
Route::middleware([RoleMiddleware::class . ':student'])->group(function () {
    Route::get('/sinh-vien/ho-so', [GiaoVienController::class, 'profile'])->name('student.profile');
    Route::post('/sinh-vien/ho-so/cap-nhat', [GiaoVienController::class, 'updateProfile'])
        ->name('giaovien.profile.update');
    Route::post('/sinh-vien/doi-mat-khau', [GiaoVienController::class, 'changePassword'])
