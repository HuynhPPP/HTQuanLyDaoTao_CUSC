...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('canbo')->group(function () {
        ...
        Route::post('/store', [CanBoController::class, 'store'])->name('canbo.store');
        Route::get('/{maCB}', [CanBoController::class, 'show'])->name('canbo.show');
        Route::get('/edit/{maCB}', [CanBoController::class, 'edit'])->name('canbo.edit');
        Route::post('/update/{maCB}', [CanBoController::class, 'update'])->name('canbo.update');
        Route::delete('/destroy/{maCB}', [CanBoController::class, 'destroy'])->name('canbo.destroy');
