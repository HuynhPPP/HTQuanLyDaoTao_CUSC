...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('staff')->group(function () {
        ...
        Route::get('/dong-bo-tai-khoan-canbo-ldap', [GiaoVienController::class, 'dongBoTaiKhoanGVLDAP'])
            ->name('giaovien.dongbo.taikhoan.ldap');
    
        Route::get('/kiem-tra-dong-bo-canbo-ldap', [GiaoVienController::class, 'kiemTraDongBoGVLDAP'])
            ->name('giaovien.ldap.kiem-tra-dong-bo');
    
        Route::get('/ldap/danh-sach-tai-khoan-canbo', [GiaoVienController::class, 'xuatDanhSachTaiKhoanMoi'])
