...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('bao-cao')->name('bao-cao.')->group(function () {
        Route::get('/upload', [BaoCaoController::class, 'uploadForm'])->name('upload.form');
        Route::post('/upload', [BaoCaoController::class, 'upload'])->name('upload');
    
        Route::get('/', [BaoCaoController::class, 'index'])->name('index');
        Route::get('/edit/{id}', [BaoCaoController::class, 'edit'])->name('edit');
        Route::post('/update/{id}', [BaoCaoController::class, 'update'])->name('update');
    
        Route::get('/export', [BaoCaoController::class, 'exportExcel'])->name('export');
    });
});
