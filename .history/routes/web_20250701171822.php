...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('thong-ke')->name('thong-ke.')->group(function () {
        ...
        Route::get('/thong-ke-bao-cao-do-an', [ThongKeBaoCaoDoAnController::class, 'showUploadForm'])->name('upload.form.doan');
        Route::post('/upload/file/thong-ke-bao-cao', [ThongKeBaoCaoDoAnController::class, 'uploadFile'])->name('upload.file.doan');
        Route::get('/reports/thong-ke-bao-cao-do-an', [ThongKeBaoCaoDoAnController::class, 'showReports'])->name('reports.show.doan');
        Route::get('/reports/export/thong-ke-bao-cao-do-an', [ThongKeBaoCaoDoAnController::class, 'exportReports'])->name('reports.export.doan');
    });
});
