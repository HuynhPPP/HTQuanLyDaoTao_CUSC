...
Route::middleware([RoleMiddleware::class . ':admin,staff,teacher'])->group(function () {
    ...
    Route::prefix('chuongtrinh')->group(function () {
        Route::get('/list', [ChuongTrinhController::class, 'index'])->name('chuongtrinh.index');
        ...
        Route::get('/edit/{maChuongTrinh}', [ChuongTrinhController::class, 'edit'])->name('chuongtrinh.edit');
        Route::post('/update/{maChuongTrinh}', [ChuongTrinhController::class, 'update'])->name('chuongtrinh.update');
        Route::delete('/destroy/{maChuongTrinh}', [ChuongTrinhController::class, 'destroy'])->name('chuongtrinh.destroy');
    });
});
