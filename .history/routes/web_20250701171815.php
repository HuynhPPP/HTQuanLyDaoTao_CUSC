...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('thong-ke')->name('thong-ke.')->group(function () {
        ...
        Route::get('/thong-ke-bao-cao-do-an', [ReportController::class, 'showUploadForm'])->name('upload.form.doan');
        Route::post('/upload/file/thong-ke-bao-cao', [ReportController::class, 'uploadFile'])->name('upload.file.doan');
        Route::get('/reports/thong-ke-bao-cao-do-an', [ReportController::class, 'showReports'])->name('reports.show.doan');
        Route::get('/reports/export/thong-ke-bao-cao-do-an', [ReportController::class, 'exportReports'])->name('reports.export.doan');
    });
});
