...
Route::middleware([RoleMiddleware::class . ':admin,staff,teacher'])->group(function () {
    ...
    Route::prefix('tochucthi')->group(function () {
        ...
        Route::get('/lich-thi/lop/{maLop}/danh-sach-sinh-vien', [LichThiController::class, 'danhSachSinhVienTheoLop'])
    ->name('lichthi.danhsach.sinhvien.lop');
Route::get('/lich-thi/lop/{maLop}/xuat-excel', [LichThiController::class, 'xuatDanhSachSinhVienExcel'])
    ->name('lichthi.xuat.sinhvien.excel');
