...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('staff')->group(function () {
        ...
        Route::get('/dong-bo-tai-khoan-canbo-ldap', [GiaoVienController::class, 'dongBoTaiKhoanLDAP'])
            ->name('giaovien.dongbo.taikhoan.ldap');
    
        Route::get('/kiem-tra-dong-bo-canbo-ldap', [GiaoVienController::class, 'kiemTraDongBoLDAP'])
