...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('thong-ke')->group(function () {
        Route::get('/sinh-vien', [ThongKeController::class, 'thongKeSinhVien']);
        Route::get('/diem-so', [ThongKeController::class, 'thongKeDiem']);
        Route::post('/hoc-luc', [ThongKeController::class, 'phanLoaiHocLuc']);
        Route::post('/bao-cao', [ThongKeController::class, 'xuatBaoCao']);
    });
});
