...
Route::middleware([RoleMiddleware::class . ':admin,staff,teacher'])->group(function () {
    ...
    Route::prefix('tochucthi')->group(function () {
        ...
        Route::get('/phancong/create', [PhanCongThiController::class, 'create'])->name('phancong.create');
        Route::post('/phancong/store', [PhanCongThiController::class, 'store'])->name('phancong.store');
