...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('giaovien')->group(function () {
        ...
        Route::get('/dong-bo-tai-khoan-gv-ldap', [GiaoVienController::class, 'dongBoTaiKhoanLDAP'])
            ->name('dongbo.taikhoan_gv.ldap');

        Route::get('/kiem-tra-dong-bo-gv-ldap', [GiaoVienController::class, 'kiemTraDongBoLDAP'])
            ->name('ldap.kiem-tra-dong-bo_gv');

        Route::get('/ldap/danh-sach-tai-khoan', [GiaoVienController::class, 'xuatDanhSachTaiKhoanMoi'])
            ->name('ldap.account_gv.list');

        Route::post('/ldap/gui-thong-tin/{id}', [GiaoVienController::class, 'guiThongTinTaiKhoan'])
            ->name('ldap.account_gv.send');
    });
