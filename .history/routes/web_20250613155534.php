...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('tochucthi')->group(function () {
        ...
        Route::get('/xuat-bang-diem/{maLop}/{maMH}', [LapBangDiemThiController::class, 'xuatBangDiemChiTiet'])
            ...
            Route::get('/chon-chuong-trinh-bang-diem-tong', [BangDiemTongController::class, 'chonChuongTrinh'])->name('chon-chuong-trinh-bang-diem-tong');
Route::get('/bang-diem-tong/{maChuongTrinh}', [BangDiemTongController::class, 'bangDiemTong'])->name('bang-diem-tong');
    });
});
