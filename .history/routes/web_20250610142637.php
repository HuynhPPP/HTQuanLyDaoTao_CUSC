...
Route::middleware([RoleMiddleware::class . ':admin,staff'])->group(function () {
    ...
    Route::prefix('tochucthi')->group(function () {
        ...
        Route::get('/chon-lop-mon-hoc', [LapBangDiemThiController::class, 'chonLopVaMonHoc'])->name('chon-lop-mon-hoc');
Route::get('/get-mon-hoc-theo-lop', [LapBangDiemThiController::class, 'getMonHocTheoLop'])->name('get-mon-hoc-theo-lop');
