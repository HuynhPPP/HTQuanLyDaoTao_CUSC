...
Route::middleware([RoleMiddleware::class . ':teacher'])->group(function () {
    ...
    Route::prefix('giao-vien/nhap-diem-thi')->group(function () {
        ...
        Route::get('/mon-hoc/{MaMH}', [NhapDiemController::class, 'danhSachLichThi'])
            ->name('giaovien.nhapdiemthi.danh-sach-lichthi');
        Route::get('/{MaLop}', [NhapDiemController::class, 'nhapDiem'])
            ->name('giaovien.nhapdiemthi.nhap-diem');
        Route::post('/luu-diem/{lophoc}', [NhapDiemController::class, 'luuDiem'])
            ->name('giaovien.nhapdiemthi.luu-diem')
            ->middleware(function ($request, $next) {
                \Log::info('Route Middleware Debug', [
                    'route_name' => 'giaovien.nhapdiemthi.luu-diem',
