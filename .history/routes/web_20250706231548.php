...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('manage_account')->group(function () {
        Route::get('/ldap/edit-account/{id}', [GiaoVienController::class, 'editLdapAccount'])
            ->name('giaovien.ldap.account.edit');
        Route::put('/ldap/update-account/{id}', [GiaoVienController::class, 'updateLdapAccount'])
            ->name('giaovien.ldap.account.update');
        Route::delete('/ldap/destroy-account/{id}', [GiaoVienController::class, 'destroyLdapAccount'])
            ->name('giaovien.ldap.account.destroy');
        Route::post('/ldap/toggle-status/{id}', [GiaoVienController::class, 'toggleLdapAccountStatus'])
