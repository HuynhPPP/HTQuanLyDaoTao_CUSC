...
Route::middleware([RoleMiddleware::class . ':admin,staff,teacher'])->group(function () {
    ...
    Route::prefix('tochucthi')->group(function () {
        ...
        Route::get('/lich-thi/lop/{maLop}/danh-sach-sinh-vien-du-thi', [LichThiController::class, 'danhSachSinhVienDuThiTheoLop'])
    ->name('lichthi.danhsach.sinhvien.duthi.lop');
Route::get('/lich-thi/lop/{maLop}/xuat-excel-du-thi', [LichThiController::class, 'xuatDanhSachSinhVienDuThiExcel'])
    ->name('lichthi.xuat.sinhvien.duthi.excel');
