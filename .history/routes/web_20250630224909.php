...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::prefix('chuongtrinh')->group(function () {
        ...
        Route::post('/quan-ly/hinh-thuc-danh-gia/xoa', [ChuongTrinhDaoTaoController::class, 'xoaHinhThucDanhGia'])->name('chuongtrinh.xoa.hinhthucdanhgia');
        Route::post('/quan-ly/tieu-chi-xep-loai/xoa', [ChuongTrinhDaoTaoController::class, 'xoaTieuChiXepLoai'])->name('chuongtrinh.xoa.hinhthucdanhgia');
    });
