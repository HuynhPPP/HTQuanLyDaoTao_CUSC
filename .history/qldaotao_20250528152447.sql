...
CREATE TABLE `diemthi` (
  ...
  `DiemLyThuyet` float DEFAULT NULL COMMENT 'Điểm thi lý thuyết trắc nghiệm (50%)',
  `DiemThucHanh` float DEFAULT NULL COMMENT 'Điểm thi thực hành (30%)',
  `DiemDuAn` float DEFAULT NULL COMMENT 'Điểm dự án (20%)',
  `DiemTongKet` float DEFAULT NULL COMMENT 'Tổng điểm sau khi tính trọng số',
  `GhiChu` text,
  `TrangThai` enum('DatChuan','ChuaDatChuan') DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `diemthi` (`MaSV`, `TenMH`, `MaLop`, `LanThi`, `DiemLyThuyet`, `DiemThucHanh`, `DiemDuAn`, `DiemTongKet`, `GhiChu`, `TrangThai`, `created_at`, `updated_at`) VALUES
('21010001', 'Phân tích Dữ liệu với MS Excel', 'CP2296H07', 2, 80, 70, 85, 78.5, 'sai xót khi chấm bài', 'DatChuan', '2025-05-26 02:41:01', '2025-05-26 02:42:27'),
('21010002', 'Phân tích Dữ liệu với MS Excel', 'CP2296H07', 2, 50, 60, 75, 65, 'sử dụng tài liệu', 'ChuaDatChuan', '2025-05-26 02:40:31', '2025-05-26 02:40:31'),
('21010003', 'Phân tích Dữ liệu với MS Excel', 'CP2296H07', 1, 80, 75, 80, 78, NULL, '2025-05-26 02:40:31', '2025-05-26 02:40:31');
