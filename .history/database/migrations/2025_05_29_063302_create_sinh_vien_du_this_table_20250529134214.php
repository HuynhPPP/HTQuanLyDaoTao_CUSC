...
return new class extends Migration {
    public function up()
    {
        Schema::create('sinhvien_duthi', function (Blueprint $table) {
            $table->id();
            $table->string('MaSV', 12)->collation('utf8mb4_0900_ai_ci');
$table->string('MaLichThi', 12)->collation('utf8mb4_0900_ai_ci');
$table->string('MaLop', 12)->collation('utf8mb4_0900_ai_ci');
