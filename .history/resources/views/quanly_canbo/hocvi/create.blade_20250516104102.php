                        ...
                        <div class="card-body">
                            <form action="{{ route('hocvi.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Mã Học Vị <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="MaHV" class="form-control @error('MaHV') is-invalid @enderror" 
