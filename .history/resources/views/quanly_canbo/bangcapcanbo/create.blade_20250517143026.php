...
@section('main-content')
    <section class="section">
        <h1>Thêm bằng cấp cán bộ</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('about') }}">Trang chủ</a></div>
            <div class="breadcrumb-item active"><a href="{{ route('bangcapcanbo.index') }}">Danh sách bằng cấp cán bộ</a></div>
            <div class="breadcrumb-item">Thêm bằng cấp cán bộ</div>
        </div>
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('MaBang') is-invalid @enderror"
                                            id="MaBang" name="MaBang" value="{{ old('MaBang') }}">
                                        @error('MaBang')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('TenBang') is-invalid @enderror"
                                            id="TenBang" name="TenBang" value="{{ old('TenBang') }}">
                                        @error('TenBang')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            name="ThoiGianCap" value="{{ old('ThoiGianCap') }}">
                                        @error('ThoiGianCap')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('DonViCap') is-invalid @enderror"
                                            id="DonViCap" name="DonViCap" value="{{ old('DonViCap') }}">
                                        @error('DonViCap')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('SoHieu') is-invalid @enderror"
                                            id="SoHieu" name="SoHieu" value="{{ old('SoHieu') }}">
                                        @error('SoHieu')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('SoVaoSo') is-invalid @enderror"
                                            id="SoVaoSo" name="SoVaoSo" value="{{ old('SoVaoSo') }}">
                                        @error('SoVaoSo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
