                    ...
                    <div class="card-body">
                        <form action="{{ route('lichthi.update', $lichThi->id) }}" method="POST">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="number" class="form-control" name="ThoiLuong" value="{{ $lichThi->ThoiLuong }}" required min="30" max="180">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control" name="HinhThucThi" required>
                                        ...
                                        <option value="Vấn Đáp" {{ $lichThi->HinhThucThi == 'Vấn Đáp' ? 'selected' : '' }}>Vấn Đáp</option>
