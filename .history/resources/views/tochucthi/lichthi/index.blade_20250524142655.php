        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="table-lichthi">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Môn Thi</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $lichThi->GioBatDau }}</td>
                                <td>{{ $lichThi->ThoiLuong }}</td>
                                <td>
                                    <a href="{{ route('lichthi.edit', $lichThi->MaLichThi) }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Sửa
                                    </a>
                                    <form action="{{ route('lichthi.destroy', $lichThi->MaLichThi) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
