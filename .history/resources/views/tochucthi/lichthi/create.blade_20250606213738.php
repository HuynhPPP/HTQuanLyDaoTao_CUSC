                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('lichthi.store') }}" method="POST">
                                        ...
                                        <select class="form-control select2" name="MaLop">
                                            ...
                                            @foreach ($lopHocs as $lopHoc)
                                                <option value="{{ $lopHoc->MaLop }}"
                                                    {{ old('MaLop') == $lopHoc->MaLop ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control" name="HinhThucThi">
                                            ...
                                            <option value="Tự luận"
                                                {{ old('HinhThucThi') == 'Tự luận' ? 'selected' : '' }}>Tự luận</option>
                                            <option value="Trắc nghiệm"
                                                {{ old('HinhThucThi') == 'Trắc nghiệm' ? 'selected' : '' }}>Trắc nghiệm
                                            </option>
                                            <option value="Bài tập lớn"
                                                {{ old('HinhThucThi') == 'Bài tập lớn' ? 'selected' : '' }}>Bài tập lớn
                                            </option>
                                            <option value="Thực hành"
                                                {{ old('HinhThucThi') == 'Thực hành' ? 'selected' : '' }}>Thực hành
                                            </option>
                                        </select>
                                        @error('HinhThucThi')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        ...
                                        <select class="form-control select2" name="PhongThi">
                                            ...
                                            @foreach ($phongHocs as $phongHoc)
                                                <option value="{{ $phongHoc->TenPhong }}"
                                                    {{ old('PhongThi') == $phongHoc->TenPhong ? 'selected' : '' }}>
                                                    {{ $phongHoc->TenPhong }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                {{-- Lần thi --}}
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Lần thi
                                    </label>
                                    <div class="col-sm-12 col-md-7">
