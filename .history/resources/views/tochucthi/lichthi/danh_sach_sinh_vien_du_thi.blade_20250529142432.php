    ...
    <tr>
        <td>
            <div class="custom-control custom-checkbox">
                ...
                <input type="hidden" name="sinhvien[{{ $sinhVien->MaSV }}][DuThi]" value="0">
        ...
        <td>{{ $sinhVien->Sdt }}</td>
        <td>
            <select name="sinhvien[{{ $sinhVien->MaSV }}][TrangThaiDuThi]" class="form-control form-control-sm trang-thai-select">
