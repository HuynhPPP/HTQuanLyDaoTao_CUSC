                                        ...
                                        <select class="form-control select2" name="TenMH" required>
                                            ...
                                            @foreach ($monHocs as $monHoc)
                                                <option value="{{ $monHoc->TenMH }}"
                                                    {{ $lichThi->TenMH == $monHoc->TenMH ? 'selected' : '' }}>
                                                    {{ $monHoc->TenMH }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="date" class="form-control" name="NgayThi"
                                            value="{{ $lichThi->NgayThi }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="time" class="form-control" name="GioBatDau"
                                            value="{{ $lichThi->GioBatDau ?? '' }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" class="form-control" name="ThoiLuong"
                                            value="{{ $lichThi->ThoiLuong ?? '' }}" required>
                                    </div>
                                </div>
