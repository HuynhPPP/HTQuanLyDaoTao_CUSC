                        ...
                        <div class="col-md-6">
                            <div class="list-group">
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge badge-warning badge-pill">{{ $lichThi->TenMH }}</span>
                                </div>
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    <strong>Lớp:</strong>
                                    <span class="badge badge-warning badge-pill">{{ $lichThi->MaLop }}</span>
                                </div>
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    <strong>Ngày Thi:</strong>
                                    <span class="badge badge-warning badge-pill">{{ $lichThi->NgayThi }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="list-group">
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge badge-warning badge-pill">{{ $lichThi->PhongThi }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
