                    ...
                    <div class="card-body">
                        <form action="{{ route('lichthi.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="NgayThi" id="NgayThi" class="form-control" value="{{ old('NgayThi') }}">
                                @error('NgayThi')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="KhungGio" id="KhungGio" class="form-control" placeholder="HH:MM - HH:MM" value="{{ old('KhungGio') }}">
                                @error('KhungGio')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="LoaiThi" id="LoaiThi" class="form-control">
                                    ...
                                    <option value="Lý thuyết" {{ old('LoaiThi') == 'Lý thuyết' ? 'selected' : '' }}>Lý thuyết</option>
                                    <option value="Thực hành" {{ old('LoaiThi') == 'Thực hành' ? 'selected' : '' }}>Thực hành</option>
                                    <option value="Bài tập lớn" {{ old('LoaiThi') == 'Bài tập lớn' ? 'selected' : '' }}>Bài tập lớn</option>
                                </select>
                                @error('LoaiThi')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select name="PhongThi" id="PhongThi" class="form-control select2">
                                    ...
                                    @foreach ($phongHocs as $phong)
                                        <option value="{{ $phong->TenPhong }}" {{ old('PhongThi') == $phong->TenPhong ? 'selected' : '' }}>
                                            {{ $phong->TenPhong }}
                                        </option>
                                    @endforeach
                                </select>
