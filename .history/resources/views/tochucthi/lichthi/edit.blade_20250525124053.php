                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control" name="HinhThucThi" required>
                                        ...
                                        <option value="Tự luận" {{ $lichThi->LoaiThi == 'Tự luận' ? 'selected' : '' }}>Tự luận</option>
                                        <option value="Trắc nghiệm" {{ $lichThi->LoaiThi == 'Trắc nghiệm' ? 'selected' : '' }}>Trắc nghiệm</option>
                                        <option value="Bài tập lớn" {{ $lichThi->LoaiThi == 'Bài tập lớn' ? 'selected' : '' }}>Bài tập lớn</option>
                                        <option value="Thực hành" {{ $lichThi->LoaiThi == 'Thực hành' ? 'selected' : '' }}>Thực hành</option>
                                    </select>
                                </div>
                            </div>
