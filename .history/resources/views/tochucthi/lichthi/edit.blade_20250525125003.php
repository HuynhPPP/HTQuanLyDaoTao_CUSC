                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('lichthi.update', $lichThi->MaLichThi) }}" method="POST">
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Thời gian thi (phút)</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="number" class="form-control" name="ThoiLuong" value="{{ $lichThi->ThoiLuong ?? '' }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control" name="HinhThucThi" required>
                                        ...
                                        <option value="Bài tập lớn" {{ $lichThi->HinhThucThi == 'Bài tập lớn' ? 'selected' : '' }}>Bài tập lớn</option>
