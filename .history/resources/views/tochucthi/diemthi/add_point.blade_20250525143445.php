                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        inputs.forEach(input => {
                            input.addEventListener('change', function() {
                                console.log(`Changed - MaSV: ${this.dataset.masv}, Field: ${this.name}, Value: ${this.value}`);
                            });
                        });
                    });
                    </script>
