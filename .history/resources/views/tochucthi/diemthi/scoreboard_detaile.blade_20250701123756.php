                        ...
                        <table class="table table-striped" id="table-1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Điểm dự án</th>
                            ...
                            <tbody>
                                @foreach ($danhSachDiem as $diem)
                                    <tr>
                                        <td>{{ $diem->MaSV }}</td>
                                        <td>{{ $diem->HoTen }}</td>
                                        <td class="text-center">{{ number_format($diem->DiemLyThuyet ?? 0, 2) }}</td>
                                        <td class="text-center">{{ number_format($diem->DiemThucHanh ?? 0, 2) }}</td>
                                        <td class="text-center">{{ number_format($diem->DiemDuAn ?? 0, 2) }}</td>
                                        <td class="text-center">{{ number_format($diem->DiemTong, 2) }}</td>
                                        <td>{{ $diem->GhiChu }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
