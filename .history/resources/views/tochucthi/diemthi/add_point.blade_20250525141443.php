                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="lanThi[{{ $sv->MaSV }}]"
                                                    class="form-control" value="{{ $sv->diem ? $sv->diem->LanThi : 1 }}"
                                                    min="1">
                                            </td>
                                            <td>
                                                <input type="number" name="diem[{{  $sv->sinhVien->MaSV }}]" class="form-control"
                                                    step="0.1" min="0" max="100"
                                                    value="{{ $sv->diem ? $sv->diem->Diem : '' }}">
                                            </td>
                                            <td>
                                                <input type="text" name="ghiChu[{{ $sv->MaSV }}]"
                                                    class="form-control" value="{{ $sv->diem ? $sv->diem->GhiChu : '' }}">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
