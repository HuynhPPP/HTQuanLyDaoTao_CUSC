...
<div class="section">
    <div class="card">
        <div class="section-header">
            <h4>Nhập điểm thi - Lớp: {{ $maLop }} - Môn: {{ $tenMH }}</h4>
        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $sv->HoTen }}</td>
                                <td>
                                    <input type="number" name="lanThi[{{ $sv->MaSV }}]" class="form-control" value="1" min="1">
                                </td>
                                <td>
                                    <input type="number" name="diem[{{ $sv->MaSV }}]" class="form-control" step="0.1" min="0" max="10">
                                </td>
                                <td>
                                    <input type="text" name="ghiChu[{{ $sv->MaSV }}]" class="form-control">
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
