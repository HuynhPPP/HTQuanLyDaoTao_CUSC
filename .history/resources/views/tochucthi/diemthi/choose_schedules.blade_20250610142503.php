...
<div class="section">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('bang-diem-chi-tiet', ['maLop' => '__maLop__', 'maMH' => '__maMH__']) }}" method="GET" id="formChonLopMon">
                <div class="row">
                    <div class="col-md-6">
...
$(document).ready(function() {
    ...
    $('#maMH').change(function() {
        ...
        var maLop = $('#maLop').val();
        var newAction = "{{ route('bang-diem-chi-tiet', ['maLop' => '__maLop__', 'maMH' => '__maMH__']) }}"
