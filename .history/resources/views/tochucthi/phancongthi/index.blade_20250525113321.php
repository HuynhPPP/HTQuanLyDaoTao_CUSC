...
<div class="section">
    <div class="section-header">
        <h1>Phân công cán bộ - {{ $lichThis->monHoc->TenMH }} ({{ $lichThis->NgayThi }})</h1>
    </div>

    <div class="section-body">

        {{-- Form phân công --}}
        <form method="POST" action="{{ route('phancong.store', $lichThis->MaLichThi) }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="VaiTro" class="form-control select2" multiple="">
