                    ...
                    <form action="{{ route('lophoc.update', $lophoc->MaLop) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="MaLop" name="MaLop" value="{{ old('MaLop', $lophoc->MaLop) }}" >
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('MaChuongTrinh') is-invalid @enderror" id="MaChuongTrinh" name="MaChuongTrinh">
                                    ...
                                    @foreach ($chuongtrinhs as $chuongtrinh)
                                        <option value="{{ $chuongtrinh->MaChuongTrinh }}" {{ old('MaChuongTrinh') == $chuongtrinh->MaChuongTrinh ? 'selected' : '' }}>{{ $chuongtrinh->TenChuongTrinh }}</option>
                                    @endforeach
                                </select>
                                @error('MaChuongTrinh')
                                    <div class="invalid-feedback">{{ $message }}</div>
