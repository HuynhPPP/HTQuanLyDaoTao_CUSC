                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <a href="{{ route('lophoc.show', $lop->MaLop) }}" class="btn btn-info btn-sm">Xem</a> --}}
                                            <a href="{{ route('lophoc.edit', $lop->MaLop) }}" class="btn btn-warning btn-sm" title="Sửa"><i
                                                class="fas fa-edit"></i></a>
                                            <form action="{{ route('lophoc.destroy', $lop->MaLop) }}" method="POST" style="display:inline;">
                                                @csrf @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm delete-lophoc">Xóa</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
