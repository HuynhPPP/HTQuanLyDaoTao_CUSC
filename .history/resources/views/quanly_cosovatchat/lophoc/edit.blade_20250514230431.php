    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('phonghoc.update', $phonghoc->MaLop) }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="MaLop" class="form-label">Mã lớp</label>
                                <input type="text" class="form-control" id="MaLop" name="MaLop" value="{{ old('MaLop', $phonghoc->MaLop) }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="TenLop" class="form-label">Tên lớp</label>
                                <input type="text" class="form-control @error('TenLop') is-invalid @enderror" id="TenLop" name="TenLop" value="{{ old('TenLop', $phonghoc->TenLop) }}">
                                @error('TenLop')
