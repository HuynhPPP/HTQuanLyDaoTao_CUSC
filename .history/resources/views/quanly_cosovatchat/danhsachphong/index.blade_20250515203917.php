                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('danhsachphong.edit', $item->MaLop) }}" class="btn btn-warning btn-sm">Sửa</a>
                                            <form action="{{ route('danhsachphong.destroy', $item->MaLop) }}" method="POST" style="display:inline;">
                                                @csrf @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm delete-danhsachphong"  title="Xóa"><i class="fas fa-trash"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
