                    ...
                    <form action="{{ route('phonghoc.update', $phonghoc->TenPhong) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="TenPhong" name="TenPhong" value="{{ old('TenPhong', $phonghoc->TenPhong) }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="LoaiPhong" class="form-label">Loại phòng <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('LoaiPhong') is-invalid @enderror" id="LoaiPhong" name="LoaiPhong" value="{{ old('LoaiPhong', $phonghoc->LoaiPhong) }}">
                                @error('LoaiPhong')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('SucChua') is-invalid @enderror" id="SucChua" name="SucChua" value="{{ old('SucChua', $phonghoc->SucChua) }}">
                                @error('SucChua')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
