...
@section('custom-js')
    ...
    const templateData = `MaSV,MaEnroll,HoTen,InDebt,NgaySinh,GioiTinh,SoCCCD,NgayCap,NoiCap,Sdt,NoiSinh,DiaChi,Zalo,Receipt,Invoice,Billing,Coll,Billing(VND),Coll(VND),Discount,LiDo,NgayDangKi,HoTenNguoiThan,MoiQuanHe,SdtNguoiThan,ZaloNguoiThan,EmailNguoiThan,Email,EmailCUSC,password_CUSC,Size,TinhTrangHocTap,created_at,updated_at
21010001,EN2025,Nguyễn Văn A,0,2003-06-12,Nam,123456789,2021-06-01,Cần Thơ,0912345678,Cần Thơ,123 Đường 3/2,0912345678,R12345,I54321,1500000.00,1500000.00,1500000,1500000,0.00,,2025-06-10,Nguyễn Văn B,Cha,0987654321,0987654321,nguoithan@gmail.com,vana@gmail.com,vana@cusc.ctu.edu.vn,matkhau123,M,DangHoc,,`;
    ...
    navigator.clipboard.writeText(templateData).then(() => {
        iziToast.success({
            message: 'Đã sao chép dữ liệu mẫu 34 cột vào clipboard!',
            position: 'topRight'
        });
    }).catch(err => {
        iziToast.error({
