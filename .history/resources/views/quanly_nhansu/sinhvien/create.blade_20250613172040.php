...
@section('custom-js')
    ...
    <script>
        ...
        function copyTemplateToClipboard() {
            const templateData =
                `Mã sinh viên,Mã nhập học,Họ tên,Ghi chú liên quan đến nợ học phí hoặc nghĩa vụ khác,Ngày sinh,Giới tính,Số CCCD,Ngày cấp,Nơi cấp,Số điện thoại,Nơi sinh,Địa chỉ,Zalo,Số phiếu thu gần nhất,Số hoá đơn ,Billing,Coll,Billing(VND),Coll(VND),Discount,LiDo,NgayDangKi,HoTenNguoiThan,MoiQuanHe,SdtNguoiThan,ZaloNguoiThan,EmailNguoiThan,Email,EmailCUSC,password_CUSC,Size,TinhTrangHocTap
