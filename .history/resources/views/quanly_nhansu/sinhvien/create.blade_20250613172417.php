...
@section('custom-js')
    ...
    <script>
        ...
        function copyTemplateToClipboard() {
            const templateData =
                `Mã sinh viên,Mã nhập học,Họ tên,InDebt,Ngày sinh,Giới tính,Số CCCD,Ngày cấp,Nơi cấp,Số điện thoại,Nơi sinh,Địa chỉ,Zalo,Receipt,Invoice,Billing,Coll,Billing(VND),Coll(VND),Discount,LiDo,Ngày đăng ký,Họ tên người thân,Mối quan hệ với người thân,Số điện thoại người thân,Zalo người thân,Email người thân,Email sinh viên,Size,TinhTrangHocTap
