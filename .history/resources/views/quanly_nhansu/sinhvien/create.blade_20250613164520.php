...
@section('main-content')
    ...
    <div class="modal fade" id="importGuideModal" tabindex="-1" role="dialog" aria-labelledby="importGuideModalLabel"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content custom-modal-width" style="width: 800px;">
...
@section('custom-js')
    ...
    <script>
        ...
        function copyTemplateToClipboard() {
            const templateData =
                `MaSV,MaEnroll,HoTen,InDebt,NgaySinh,GioiTinh,SoCCCD,NgayCap,NoiCap,Sdt,NoiSinh,DiaChi,Zalo,Receipt,Invoice,Billing,Coll,Billing(VND),Coll(VND),Discount,LiDo,NgayDangKi,HoTenNguoiThan,MoiQuanHe,SdtNguoiThan,ZaloNguoiThan,EmailNguoiThan,Email,EmailCUSC,password_CUSC,Size,TinhTrangHocTap,created_at,updated_at
