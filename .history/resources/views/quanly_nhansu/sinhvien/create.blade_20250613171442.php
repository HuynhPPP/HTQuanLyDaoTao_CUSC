...
@section('custom-js')
    ...
    <script>
        ...
        function copyTemplateToClipboard() {
            const templateData =
                `Mã sinh viên,Mã nhập học,Họ tên,InDebt,NgaySinh,GioiTinh,SoCCCD,NgayCap,NoiCap,Sdt,NoiSinh,DiaChi,Zalo,Receipt,Invoice,Billing,Coll,Billing(VND),Coll(VND),Discount,LiDo,NgayDangKi,HoTenNguoiThan,MoiQuanHe,SdtNguoiThan,ZaloNguoiThan,EmailNguoiThan,Email,EmailCUSC,password_CUSC,Size,TinhTrangHocTap
