        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">
                    <a href="{{ route('ldap.account.list') }}">Danh sách tài shoản</a>
                </div>
                <div class="breadcrumb-item">Chỉnh sửa thông tin tài khoản</div>
            </div>
        </div>
                            ...
                            <form action="{{ route('ldap.account.update', $ldapAccount->id) }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" value="{{ $ldapAccount->MaTaiKhoan }}"
                                            readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" value="{{ $ldapAccount->full_name }}"
                                            readonly>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="is_active" class="custom-control-input"
                                                id="is_active" {{ $ldapAccount->is_active ? 'checked' : '' }}>
