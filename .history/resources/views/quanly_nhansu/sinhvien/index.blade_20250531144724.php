                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-end align-items-center">
                            <h4></h4>
                            <a href="{{ route('ldap.account.list') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Danh sách tài khoản sinh viên 
                            </a>
                            <a href="{{ route('student.create') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Thêm sinh viên 
                            </a>
                            <a href="{{ route('dongbo.taikhoan.ldap') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Tự tạo tài khoản cho sinh viên 
                            </a>
                            <a href="{{ route('ldap.kiem-tra-dong-bo') }}" class="btn btn-primary">
                                <i class="fas fa-plus"></i> Kiểm tra kết nối máy chủ
                            </a>
                        </div>
                        <div class="card-body">
