...
@section('main-content')
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <span class="">Gửi thông tin tài khoản hệ thống đến sinh viên qua email cá nhân</span>
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <span class="card-title">Gửi thông tin tài khoản hệ thống đến sinh viên qua email cá nhân</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" 
                                                           name="chonTaiKhoan[]" 
                                                           value="{{ $account->id }}"
                                                           class="chon-tai-khoan"
                                                           {{ $account->is_sent ? 'disabled' : '' }}>
                                                </td>
                                                <td>{{ $account->MaTaiKhoan }}</td>
                                                <td>{{ $account->full_name }}</td>
                                                <td>{{ $account->username }}</td>
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Lỗi',
                    text: xhr.responseJSON.message || 'Có lỗi xảy ra khi gửi email'
                });
            }
        });
    });
