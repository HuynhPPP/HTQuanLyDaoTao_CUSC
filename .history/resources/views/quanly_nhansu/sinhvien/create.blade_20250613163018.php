...
@section('main-content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        <ol>
                            <li><strong>Cần giữ nguyên thứ tự 34 cột</strong> như mẫu. Không được đổi tên hay thêm bớt cột.</li>
                            <li><strong>Các cột bắt buộc:</strong> <code>MaSV, HoTen, NgaySinh, GioiTinh, SoCCCD, Email, Sdt, TinhTrangHocTap</code></li>
                            <li><code>GioiTinh</code> chỉ chấp nhận <code>Nam</code> hoặc <code>Nữ</code></li>
                            <li><code>TinhTrangHocTap</code> nên nhập: <code>DangHoc</code>, <code>TotNghiep</code>, <code>ThoiHoc</code>…</li>
                            <li><code>NgaySinh</code>, <code>NgayCap</code>, <code>NgayDangKi</code> theo định dạng <code>yyyy-mm-dd</code></li>
                        </ol>
                    </div>
    ...
    MaSV, MaEnroll, HoTen, InDebt, NgaySinh, GioiTinh, SoCCCD, NgayCap, NoiCap, Sdt, NoiSinh, DiaChi, Zalo, Receipt, Invoice, Billing, Coll, Billing(VND), Coll(VND), Discount, LiDo, NgayDangKi, HoTenNguoiThan, MoiQuanHe, SdtNguoiThan, ZaloNguoiThan, EmailNguoiThan, Email, EmailCUSC, password_CUSC, Size, TinhTrangHocTap, created_at, updated_at
                    ...
                    <div class="alert alert-warning">
                        ...
                        Nếu bạn không chắc chắn, hãy sử dụng nút <strong>"Tải file mẫu"</strong> hoặc <strong>"Sao chép dữ liệu mẫu"</strong> để tránh lỗi định dạng!
                    </div>
                </div>
