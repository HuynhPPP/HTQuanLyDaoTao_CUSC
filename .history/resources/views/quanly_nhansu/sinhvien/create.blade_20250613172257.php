...
@section('custom-js')
    ...
    <script>
        ...
        function copyTemplateToClipboard() {
            const templateData =
                `Mã sinh viên,Mã nhập học,Họ tên,Indebut,Ngày sinh,Giới tính,Số CCCD,Ngày cấp,Nơi cấp,Số điện thoại,Nơi sinh,Địa chỉ,Zalo,Receipt,Invoice,Billing,Coll,Billing(VND),Coll(VND),Discount,LiDo,NgayDangKi,HoTenNguoiThan,MoiQuanHe,SdtNguoiThan,ZaloNguoiThan,EmailNguoiThan,Email,EmailCUSC,password_CUSC,Size,TinhTrangHocTap
