...
function downloadTemplate() {
    try {
        ...
        const helperRow = [
            "Bắt buộc, duy nhất", "Tùy chọn", "Bắt buộc", "Số tiền nợ (VD: 0 hoặc 100000)", "YYYY-MM-DD", "Nam/Nữ (1/0)", "Chỉ số",
            "YYYY-MM-DD", "Nơi cấp CCCD", "Số điện thoại hợp lệ", "Nơi sinh", "Địa chỉ cư trú", "Zalo cá nhân", "Mã biên nhận", "Mã hóa đơn",
            "Số tiền phải đóng", "Số tiền đã thu", "Tổng tiền (VNĐ)", "Thu (VNĐ)", "Chiết khấu dạng số thập phân (VD: 0.1)", "Lý do đặc biệt (nếu có)",
            "Ngày đăng ký", "Tên người thân", "Quan hệ (Cha/Mẹ/...)", "SĐT người thân", "Zalo người thân", "Email người thân",
            "Email chính", "Email CUSC", "Mật khẩu CUSC", "Size áo đồng phục", "DangHoc/DaTotNghiep/DaNghiHoc", "Auto hoặc để trống", "Auto hoặc để trống"
        ];

        const sampleRow = [
            "21010001", "EN2025", "Nguyễn Văn A", "0", "2003-06-12", "Nam", "123456789", "2021-06-01", "Cần Thơ",
            "0912345678", "Cần Thơ", "123 Đường 3/2", "0912345678", "R12345", "I54321", "1500000.00", "1500000.00",
