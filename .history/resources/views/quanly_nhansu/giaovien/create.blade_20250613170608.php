            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        <ol>
                            <li>Các cột bắt buộc: <code>Mã giảng viên, Họ tên giảng viên, Giới tính, email, loaigv</code></li>
    ...
    <script>
        ...
        function downloadTemplate() {
            try {
                // Dữ liệu mẫu cứng
                const headerRow =
                    "Mã giảng viên,Họ tên giảng viên,Giới tính,email,sdt,loaigv,mahv,tenhocvi,tenchucvu,madv,tendvhientai,mabang,tenbang,chuyennganh,ngaybatdaucongtac,ghichu";
                const dataRow1 =
