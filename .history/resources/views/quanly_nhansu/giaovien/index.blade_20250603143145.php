                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('ldap.account_gv.list') }}" class="btn btn-outline-primary">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ route('dongbo.taikhoan_gv.ldap') }}">
                                            <i class="fas fa-sync mr-1"></i>Tự tạo tài khoản CUSC
                                        </a>
                                        <a class="dropdown-item" href="{{ route('ldap.kiem-tra-dong-bo-gv') }}">
...
@section('custom-js')
    <script>
        ...
        $('a[href="{{ route('dongbo.taikhoan_gv.ldap') }}"]').click(function(e) {
            e.preventDefault();
