                            ...
                            <form action="{{ route('giaovien.profile.update') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $giaoVien->MaGV }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Họ tên</label>
                                            <input type="text" class="form-control" value="{{ $giaoVien->HoTenGV }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" value="{{ $giaoVien->EmailCUSC }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Học vị</label>
                                            <input type="text" class="form-control" value="{{ $giaoVien->HocVi }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Chức vụ</label>
                                            <input type="text" class="form-control" value="{{ $giaoVien->TenChucVu }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Đơn vị</label>
                                            <input type="text" class="form-control" value="{{ $giaoVien->DonViCongTac }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $giaoVien->LoaiGV == 'CoHuu' ? 'Cơ Hữu' : 'Mời Giảng' }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card profile-widget">
                        ...
                        <div class="profile-widget-description">
                            ...
                            <p>
                                {{ $giaoVien->ChuyenNganh ? 'Chuyên ngành: ' . $giaoVien->ChuyenNganh : 'Chưa cập nhật chuyên ngành' }}
                            </p>
                        </div>
                    </div>
                </div>
