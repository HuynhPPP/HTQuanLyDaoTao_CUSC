                            ...
                            <div class="card-header-action">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <button class="dropdown-item" id="btnKiemTraLDAP">
                                            <i class="fas fa-server mr-1"></i>Kiểm tra tài khoản chưa có Email CUSC
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        .then(data => {
                            if (data.status === 'success') {
                                Swal.fire({
                                    icon: 'success',
                                    title: data.message,
                                    html: `<p>Số lượng giảng viên chưa có tài khoản: <strong>${data.so_luong_giao_vien_chua_co_tai_khoan}</strong></p>`
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
