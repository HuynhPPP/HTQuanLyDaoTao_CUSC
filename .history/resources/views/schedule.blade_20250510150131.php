...
@section('main-content')
    ...
    @endphp
    <section class="section my-5" style="min-height: 100vh;">
                            ...
                            <div class="row justify-content-between mb-4">
                                ...
                                <div class="col-md-6 text-start">
                                    ...
                                    <p class="mb-1">Học Lý thuyết tại phòng:
                                        <strong>{{ $phonglt->TenPhong ?? ' Chưa có ' }}</strong></p>
                                    <p class="mb-1">Học Thực hành tại phòng:
                                        <strong>{{ $phongth->TenPhong ?? ' Chưa có ' }}</strong></p>
                                </div>
                            </div>
        ...
        <div class="position-fixed bottom-0 start-0 m-3">
            <div class="mb-2">
                <button type="button" class="btn btn-primary btn-lg rounded-circle" id="addTimeSlotButton"
                    data-bs-toggle="modal" data-bs-target="#timeSlotModal" title="Thêm khung giờ học">
                    <i class="fas fa-clock"></i>
                </button>
            </div>
            <div class="mb-2">
                <button type="button" class="btn btn-primary btn-lg rounded-circle" id="addAbsenceButton"
                    data-bs-toggle="modal" data-bs-target="#absenceModal" title="Thêm ngày nghỉ">
                    <i class="fas fa-plus"></i>
                </button>
            </div>
            <div class="mb-2">
                <button type="button" class="btn btn-primary btn-lg rounded-circle" id="addSelfStudy"
                    data-bs-toggle="modal" data-bs-target="#SelfStudyModal" title="Thêm ngày tự học">
                    <i class="fa-brands fa-leanpub"></i>
                </button>
            </div>
            <div class="mb-2">
                <button type="button" class="btn btn-primary btn-lg rounded-circle" id="editTKB" data-bs-toggle="modal"
                    data-bs-target="#EditTKBModal" title="Chỉnh sửa thời gian khai giảng">
