...
@section('main-content')
                                    ...
                                    <tbody>
                                        @foreach ($hoSo as $hs)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-{{ $hs->TrangThaiHS == 'DaTrungTuyen'
                                                            ? 'success'
                                                            : ($hs->TrangThaiHS == 'KhongTrungTuyen'
                                                                ? 'danger'
                                                                : ($hs->TrangThaiHS == 'DaXet'
                                                                    ? 'warning'
                                                                    : 'info')) }}">
                                                        {{ $hs->TrangThaiHS }}
                                                    </span>
    ...
    <input type="text" class="form-control @error('MaSV') is-invalid @enderror" name="MaSV" value="{{ old('MaSV') }}">
    @error('MaSV')
    ...
    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="NgayNopHS">
                        </div>
                    </div>
