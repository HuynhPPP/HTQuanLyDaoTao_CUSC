                                    ...
                                    <tbody>
                                        @foreach ($hoSo as $hs)
                                            <tr>
                                                ...
                                                <td>{{ $hs->NgayNopHS }}</td>
                                                <td>
                                                    <span class="badge badge-{{ $hs->TrangThaiHS == 'DaTrungTuyen' ? 'success' : ($hs->TrangThaiHS == 'KhongTrungTuyen' ? 'danger' : ($hs->TrangThaiHS == 'DaXet' ? 'info' : 'warning')) }}">
                                                ...
                                                <td>
                                                    <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                        data-target="#modalCapNhatTrangThai"
