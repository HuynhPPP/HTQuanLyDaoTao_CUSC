    ...
    <div class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('tuyensinh.index') }}">Danh sách đợt tuyển sinh</a></div>
    ...
    <div class="modal fade" id="modalCapNhatTrangThai" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('tuyensinh.capnhat_trangthai', $hoSo->MaHoSo) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
