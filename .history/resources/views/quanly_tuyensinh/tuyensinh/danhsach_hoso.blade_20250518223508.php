                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $hs->NgayNopHS }}</td>
                                        <td>
                                            <span class="badge badge-{{ $hs->TrangThaiHS == 'DaTrungTuyen' ? 'success' : 
                                                ($hs->TrangThaiHS == 'KhongTrungTuyen' ? 'danger' : 
                                                ($hs->TrangThaiHS == 'DaXet' ? 'warning' : 'info')) }}">
                                                {{ $hs->TrangThaiHS }}
                                            </span>
                                        </td>
                                        <td>
                                            <button class="btn btn-warning btn-sm" onclick="capNhatTrangThai('{{ $hs->MaHoSo }}')">
...
<div class="modal fade" id="modalThemHoSo" tabindex="-1" role="dialog">
            ...
            <form action="{{ route('tuyensinh.tao_hoso') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        @error('MaSV') is-invalid @enderror" name="MaSV" value="{{ old('MaSV') }}">
    @error('MaSV')
    ...
    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="NgayNopHS" required>
                    </div>
                </div>
