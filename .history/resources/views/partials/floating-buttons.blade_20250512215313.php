            ...
            <div class="modal-body">
                <form id="timeSlotForm" method="POST" action="{{ route('saveTimeSlot', ['TenTKB' => $schedule->TenTKB]) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select id="khunggio" class="form-control @error('khunggio') is-invalid @enderror" name="khunggio">
            ...
            <div class="modal-body">
                <form id="SelfStudyForm" method="POST" action="{{ route('saveSelfStudy', ['TenTKB' => $schedule->TenTKB]) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select id="ngaytuhoc" class="form-control @error('ngaytuhoc') is-invalid @enderror" name="ngaytuhoc">
