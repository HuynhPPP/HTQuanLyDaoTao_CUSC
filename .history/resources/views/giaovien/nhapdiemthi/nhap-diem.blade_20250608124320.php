    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('giaovien.nhapdiemthi.danh-sach-mon') }}">Danh sách môn học để nhập điểm</a></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="diems[{{ $sinhVien->MaSV }}][LanThi]"
                                                    ...
                                                    value="{{ $diemThi ? $diemThi->LanThi : 1 }}" readonly>
                                            </td>
                                            @switch($lichThi->HinhThucThi)
                                                @case('Trắc nghiệm')
                                                    <td>
                                                ...
                                                @case('Dự án')
                                                    <td>
                                                        <input type="number" name="diems[{{ $sinhVien->MaSV }}][DiemDuAn]"
                                                            class="form-control"
                                                            value="{{ $diemThi ? $diemThi->DiemDuAn : '' }}">
                                                    </td>
                                                    @break
                                                @default
                                                    <td>
