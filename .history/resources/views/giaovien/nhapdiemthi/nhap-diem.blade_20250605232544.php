...
<div class="section-header">
    <h1>Nhập Điểm Thi - {{ $lichThi->TenMH }}</h1>
</div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-action">
                <span>Ngày Thi: {{ \Carbon\Carbon::parse($lichThi->NgayThi)->format('d/m/Y') }}</span>
                <span class="ml-3">Phòng Thi: {{ $lichThi->PhongThi }}</span>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('giaovien.nhapdiemthi.luu-diem', ['maLichThi' => $lichThi->MaLichThi]) }}" method="POST">
                @csrf
