                                ...
                                <form action="{{ route('giaovien.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('MaGV') is-invalid @enderror" id="MaGV"
                                                name="MaGV" value="{{ old('MaGV') }}">
                                            @error('MaGV')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="HoTenGV" class="form-label">Họ và tên <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('HoTenGV') is-invalid @enderror"
                                                id="HoTenGV" name="HoTenGV" value="{{ old('HoTenGV') }}">
                                            @error('HoTenGV')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control @error('LoaiGV') is-invalid @enderror"
                                                ...
                                                <option value="CoHuu" {{ old('LoaiGV') == 'CoHuu' ? 'selected' : '' }}>
                                                    Cơ hữu</option>
                                                <option value="MoiGiang" {{ old('LoaiGV') == 'MoiGiang' ? 'selected' : '' }}>
                                                    Mời giảng</option>
                                            </select>
                                            @error('LoaiGV')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                id="NgayBatDauCongTac" name="NgayBatDauCongTac" value="{{ old('NgayBatDauCongTac') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('GhiChu') is-invalid @enderror"
                                                id="GhiChu" name="GhiChu" rows="3">{{ old('GhiChu') }}</textarea>
                                            @error('GhiChu')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
