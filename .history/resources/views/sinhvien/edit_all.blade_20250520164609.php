                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="GioiTinh" required>
                                                <option value="1" {{ $sinhVien->GioiTinh == 1 ? 'selected' : '' }}>Nam</option>
                                                <option value="0" {{ $sinhVien->GioiTinh == 0 ? 'selected' : '' }}>Nữ</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Số CCCD</label>
                                            <input type="text" class="form-control" name="SoCCCD" value="{{ $sinhVien->SoCCCD }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Ngày cấp</label>
                                            <input type="date" class="form-control" name="NgayCap" value="{{ $sinhVien->NgayCap }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Nơi cấp</label>
                                            <input type="text" class="form-control" name="NoiCap" value="{{ $sinhVien->NoiCap }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="EmailCUSC" value="{{ $sinhVien->EmailCUSC }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Zalo</label>
                                            <input type="text" class="form-control" name="Zalo" value="{{ $sinhVien->Zalo }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="HoTenNguoiThan" value="{{ $sinhVien->HoTenNguoiThan }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Mối quan hệ</label>
                                            <input type="text" class="form-control" name="MoiQuanHe" value="{{ $sinhVien->MoiQuanHe }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Số điện thoại</label>
                                            <input type="text" class="form-control" name="SdtNguoiThan" value="{{ $sinhVien->SdtNguoiThan }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" class="form-control" name="EmailNguoiThan" value="{{ $sinhVien->EmailNguoiThan }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Zalo</label>
                                            <input type="text" class="form-control" name="ZaloNguoiThan" value="{{ $sinhVien->ZaloNguoiThan }}">
                                        </div>
                                    </div>
                                </div>
