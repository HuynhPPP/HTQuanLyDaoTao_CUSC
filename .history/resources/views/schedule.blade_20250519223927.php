                        ...
                        <div class="card-footer text-center">
                            <div class="buttons">
                                <form id="deleteScheduleForm" class="d-inline" 
                                    action="{{ route('deleteSchedule', ['TenTKB' => $schedule->TenTKB]) }}" 
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-icon btn-danger delete-schedule" data-toggle="tooltip" title="Xóa">
                                        <i class="fas fa-trash-alt"></i>
                                    </button>
                                </form>
                                <a href="{{ route('exportExcel', $schedule->TenTKB) }}" class="btn btn-icon btn-primary" data-toggle="tooltip" title="Xuất Excel">
                                    <i class="fas fa-file-excel"></i>
                                </a>
                                <button type="button" class="btn btn-icon btn-info" data-toggle="modal" data-target="#timeSlotModal" title="Khung giờ">
                                    <i class="fas fa-clock"></i>
                                </button>
                                <button type="button" class="btn btn-icon btn-success" data-toggle="modal" data-target="#absenceModal" title="Thêm ngày nghỉ">
                                    <i class="fas fa-plus"></i>
                                </button>
                                <button type="button" class="btn btn-icon btn-warning" data-toggle="modal" data-target="#SelfStudyModal" title="Thêm ngày tự học">
                                    <i class="fa-brands fa-leanpub"></i>
                                </button>
                                <button type="button" class="btn btn-icon btn-primary" data-toggle="modal" data-target="#EditTKBModal" title="Chỉnh sửa">
...
.event-start { background-color: #dc3545 !important; border-color: #dc3545 !important; }
.event-end { background-color: #6f42c1 !important; border-color: #6f42c1 !important; }
.event-exam { background-color: #007bff !important; border-color: #007bff !important; }
.event-self-study { background-color: #28a745 !important; border-color: #28a745 !important; }
.event-holiday { background-color: #ffc107 !important; border-color: #ffc107 !important; }
</style>
