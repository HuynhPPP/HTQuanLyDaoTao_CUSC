...
<div class="section">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('thong-ke.thong-ke-hoc-tap', ['maChuongTrinh' => '__maChuongTrinh__']) }}" method="GET" id="formChonChuongTrinh">
...
$(document).ready(function() {
    $('#maChuongTrinh').change(function() {
        ...
        var newAction = "{{ route('thong-ke.thong-ke.hoc-tap', ['maChuongTrinh' => '__maChuongTrinh__']) }}"
