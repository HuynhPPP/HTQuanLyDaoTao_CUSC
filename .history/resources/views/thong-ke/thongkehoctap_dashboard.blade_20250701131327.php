...
<div class="section">
    ...
    <div class="tab-content" id="tabs-content">
        <div class="tab-pane fade show active" id="monhoc" role="tabpanel">
            @include('thongke.partials.diem_monhoc')
        </div>
        <div class="tab-pane fade" id="datmon" role="tabpanel">
            @include('thongke.partials.datmon')
        </div>
        <div class="tab-pane fade" id="tongket" role="tabpanel">
            @include('thongke.partials.tongket_hocluc')
        </div>
    </div>
</div>
@endsection
...
@section('custom-js')
<!-- Gắn thư viện biểu đồ -->
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    // Tùy chọn thêm: gọi các biểu đồ nếu có trong các tab
</script>
@endsection
