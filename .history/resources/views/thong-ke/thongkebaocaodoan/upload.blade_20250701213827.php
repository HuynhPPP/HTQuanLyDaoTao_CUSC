        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('bao-cao.debugParse') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="file" name="report_file" accept=".doc,.docx">
                        <button type="submit">Debug Parse</button>
                    </form>
                </div>
            </div>
        </div>
