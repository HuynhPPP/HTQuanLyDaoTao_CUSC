    ...
    <div class="section-body">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('thong-ke.upload.file.doan') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('reports.show.doan') }}" class="btn btn-link text-decoration-none">
