                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="custom-file">
                                                    <input type="file" name="file" class="custom-file-input @error('file') is-invalid @enderror" id="importFile" accept=".xlsx,.xls,.csv">
                            ...
                            <!-- Hiển thị danh sách lỗi khi import -->
                            @if(session('import_errors') && count(session('import_errors')) > 0)
                                <div class="card mb-4">
                                    <div class="card-header bg-danger text-white">
                                        <h6 class="mb-0"><i class="fas fa-exclamation-triangle"></i> Danh sách lỗi khi import</h6>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-group">
