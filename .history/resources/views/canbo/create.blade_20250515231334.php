        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="excelTemplateData" style="display: none;">macb,hotencb,gioitinh,email,sdt,mahv,tenhocvi,tenchucvu,congviecphutrach,madv,tendvhientai,mabang,tenbang,mataphuan,tenkhoataphuan,thoigianbdcongtaccusc,thoigianktcongtaccusc
CB001,Nguyễn Văn An,Nam,ngvanan@gmail.com,0912345678,HV001,Tiến sĩ,Giảng viên,Giảng dạy CNTT,DV001,Khoa CNTT,BC001,Bằng TSKH,TH001,Khóa đào tạo GV,2020-01-01,
CB002,Trần Thị Bình,Nữ,tranthib@gmail.com,0923456789,HV002,Thạc sĩ,Trưởng khoa,Quản lý khoa CNTT,DV002,Khoa Kinh tế,BC002,Bằng ThS,TH002,Khóa QLNN,2018-05-15,
CB003,Lê Văn Cường,Nam,levcuong@gmail.com,0934567890,HV003,Cử nhân,Chuyên viên,Quản trị hệ thống,DV003,Phòng CNTT,BC003,Bằng ĐH,TH003,Khóa ATTT,2019-08-20,2022-12-31</div>
...
@section('custom-js')
    ...
    <script>
        ...
        function downloadTemplate() {
            try {
                // Lấy dữ liệu thô
                let rawData = document.getElementById('excelTemplateData').innerText;
                
                // Xử lý dữ liệu để đảm bảo định dạng đúng
                rawData = rawData.replace(/\s+/g, ' ').trim();
                
                // Tách dữ liệu thành các dòng
                const lines = rawData.split(/[\r\n]+/).map(line => line.trim()).filter(line => line.length > 0);
                
                // Nếu không có dòng nào được tách ra, thử tách theo dấu phẩy
                let rows = [];
                if (lines.length <= 1) {
                    // Dữ liệu mẫu cứng để đảm bảo luôn có dữ liệu
                    const headerRow = "macb,hotencb,gioitinh,email,sdt,mahv,tenhocvi,tenchucvu,congviecphutrach,madv,tendvhientai,mabang,tenbang,mataphuan,tenkhoataphuan,thoigianbdcongtaccusc,thoigianktcongtaccusc";
                    const dataRow1 = "CB001,Nguyễn Văn An,Nam,ngvanan@gmail.com,0912345678,HV001,Tiến sĩ,Giảng viên,Giảng dạy CNTT,DV001,Khoa CNTT,BC001,Bằng TSKH,TH001,Khóa đào tạo GV,2020-01-01,";
                    const dataRow2 = "CB002,Trần Thị Bình,Nữ,tranthib@gmail.com,0923456789,HV002,Thạc sĩ,Trưởng khoa,Quản lý khoa CNTT,DV002,Khoa Kinh tế,BC002,Bằng ThS,TH002,Khóa QLNN,2018-05-15,";
                    const dataRow3 = "CB003,Lê Văn Cường,Nam,levcuong@gmail.com,0934567890,HV003,Cử nhân,Chuyên viên,Quản trị hệ thống,DV003,Phòng CNTT,BC003,Bằng ĐH,TH003,Khóa ATTT,2019-08-20,2022-12-31";
                ...
                // Xuất file
                XLSX.writeFile(wb, 'danh_sach_can_bo_mau.xlsx');
                ...
                // Dữ liệu mẫu cứng
                const csvData = `macb,hotencb,gioitinh,email,sdt,mahv,tenhocvi,tenchucvu,congviecphutrach,madv,tendvhientai,mabang,tenbang,mataphuan,tenkhoataphuan,thoigianbdcongtaccusc,thoigianktcongtaccusc
CB001,Nguyễn Văn An,Nam,ngvanan@gmail.com,0912345678,HV001,Tiến sĩ,Giảng viên,Giảng dạy CNTT,DV001,Khoa CNTT,BC001,Bằng TSKH,TH001,Khóa đào tạo GV,2020-01-01,
CB002,Trần Thị Bình,Nữ,tranthib@gmail.com,0923456789,HV002,Thạc sĩ,Trưởng khoa,Quản lý khoa CNTT,DV002,Khoa Kinh tế,BC002,Bằng ThS,TH002,Khóa QLNN,2018-05-15,
CB003,Lê Văn Cường,Nam,levcuong@gmail.com,0934567890,HV003,Cử nhân,Chuyên viên,Quản trị hệ thống,DV003,Phòng CNTT,BC003,Bằng ĐH,TH003,Khóa ATTT,2019-08-20,2022-12-31`;

                // Phương pháp thay thế: Tạo CSV với dữ liệu cứng
