                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="custom-file">
                                                    <input type="file" name="file" class="custom-file-input" id="importFile" accept=".xlsx,.xls,.csv">
...
<script>
            ...
            if (fileName) {
                ...
                if ($.inArray(extension, ['xlsx', 'xls', 'csv']) == -1) {
                    ...
                    if (!$(this).next().next('.invalid-feedback').length) {
                        $('<div class="invalid-feedback">File phải có định dạng Excel (.xlsx, .xls, .csv)</div>').insertAfter($(this).next());
                    }
                } else {
        ...
        $('form[action="{{ route('staff.import') }}"]').on('submit', function(e) {
            if (!$('#importFile').val()) {
                ...
                if (!$('#importFile').next().next('.invalid-feedback').length) {
                    $('<div class="invalid-feedback">Vui lòng chọn file để import</div>').insertAfter($('#importFile').next());
                }
        ...
        $('#addStaffForm').on('submit', function(e) {
            ...
            if ($('#MaCB').val() === '') {
                ...
                if (!$('#MaCB').next('.invalid-feedback').length) {
                    $('<div class="invalid-feedback">Vui lòng nhập mã cán bộ</div>').insertAfter('#MaCB');
                }
                isValid = false;
            } else {
            ...
            if ($('#HoTenCB').val() === '') {
                ...
                if (!$('#HoTenCB').next('.invalid-feedback').length) {
                    $('<div class="invalid-feedback">Vui lòng nhập họ tên cán bộ</div>').insertAfter('#HoTenCB');
                }
                isValid = false;
            } else {
            ...
            if ($('#GioiTinh').val() === '') {
                ...
                if (!$('#GioiTinh').next('.invalid-feedback').length) {
                    $('<div class="invalid-feedback">Vui lòng chọn giới tính</div>').insertAfter('#GioiTinh');
                }
                isValid = false;
            } else {
            ...
            if ($('#Email').val() === '') {
                ...
                $('#Email').addClass('is-invalid');
                if (!$('#Email').next('.invalid-feedback').length) {
                    $('<div class="invalid-feedback">Email không đúng định dạng</div>').insertAfter('#Email');
                }
                isValid = false;
            } else {
            ...
            if ($('#Sdt').val() === '') {
                ...
                if (!$('#Sdt').next('.invalid-feedback').length) {
                    $('<div class="invalid-feedback">Vui lòng nhập số điện thoại</div>').insertAfter('#Sdt');
                }
                isValid = false;
            } else if (!phoneRegex.test($('#Sdt').val())) {
                $('#Sdt').addClass('is-invalid');
                if (!$('#Sdt').next('.invalid-feedback').length) {
                    $('<div class="invalid-feedback">Số điện thoại phải có 10-11 chữ số</div>').insertAfter('#Sdt');
                }
                isValid = false;
            } else {
    ...
    function downloadTemplate() {
        try {
            ...
            iziToast.warning({
                title: 'Lưu ý',
                message: 'Đã tải file CSV. Khi mở trong Excel, hãy chọn "Delimited" và chọn dấu phẩy làm delimiter.',
                position: 'topRight',
                timeout: 10000
            });
        }
