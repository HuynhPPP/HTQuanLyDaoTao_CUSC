        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">
                    <a href="{{ route('staff.index') }}">Danh sách cán bộ</a>
                </div>
                <div class="breadcrumb-item">Thêm cán bộ mới</div>
                <div class="section-header-breadcrumb">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="excelTemplateData" style="display: none;">
                        ...
                        thống,DV003,Phòng CNTT,BC003,Bằng ĐH,TH003,Khóa ATTT,2019-08-20,2022-12-31</div>
