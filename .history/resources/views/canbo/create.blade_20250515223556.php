            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-success">
                        <i class="fas fa-check-circle"></i> <strong>Chức năng mới:</strong> Hệ thống sẽ tự động tạo các dữ liệu liên quan (học vị, chức vụ, đơn vị...) nếu chưa tồn tại!
                    </div>

                    <div class="card mb-3">
                        <div class="card-header bg-info text-white">
                            <h6 class="mb-0">Mô tả các cột trong file Excel</h6>
                        </div>
                        <div class="card-body">
                            <ul class="list-group">
                                <li class="list-group-item"><strong>macb</strong>: Mã cán bộ, độ dài tối đa 10 ký tự, không được trùng (bắt buộc)</li>
                                <li class="list-group-item"><strong>hotencb</strong>: Họ tên đầy đủ của cán bộ (bắt buộc)</li>
                                <li class="list-group-item"><strong>gioitinh</strong>: Giới tính, chỉ nhận giá trị "Nam" hoặc "Nữ" (bắt buộc)</li>
                                <li class="list-group-item"><strong>email</strong>: Địa chỉ email hợp lệ (bắt buộc)</li>
                                <li class="list-group-item"><strong>sdt</strong>: Số điện thoại, chỉ chứa số, độ dài 10-11 ký tự (bắt buộc)</li>
                                <li class="list-group-item"><strong>mahv</strong>: Mã học vị, nếu chưa có sẽ tự động tạo mới</li>
                                <li class="list-group-item"><strong>tenhocvi</strong>: Tên học vị, sử dụng khi cần tạo mới học vị</li>
                                <li class="list-group-item"><strong>tenchucvu</strong>: Tên chức vụ, nếu chưa có sẽ tự động tạo mới</li>
                                <li class="list-group-item"><strong>congviecphutrach</strong>: Mô tả công việc được phụ trách</li>
                                <li class="list-group-item"><strong>madv</strong>: Mã đơn vị, nếu chưa có sẽ tự động tạo mới</li>
                                <li class="list-group-item"><strong>tendvhientai</strong>: Tên đơn vị hiện tại, sử dụng khi cần tạo mới đơn vị</li>
                                <li class="list-group-item"><strong>mabang</strong>: Mã bằng cấp, nếu chưa có sẽ tự động tạo mới</li>
                                <li class="list-group-item"><strong>tenbang</strong>: Tên bằng cấp, sử dụng khi cần tạo mới bằng cấp</li>
                                <li class="list-group-item"><strong>mataphuan</strong>: Mã tập huấn, nếu chưa có sẽ tự động tạo mới</li>
                                <li class="list-group-item"><strong>tenkhoataphuan</strong>: Tên khóa tập huấn, sử dụng khi cần tạo mới khóa tập huấn</li>
                                <li class="list-group-item"><strong>thoigianbdcongtaccusc</strong>: Thời gian bắt đầu công tác, định dạng YYYY-MM-DD</li>
                                <li class="list-group-item"><strong>thoigianktcongtaccusc</strong>: Thời gian kết thúc công tác, định dạng YYYY-MM-DD, để trống nếu vẫn đang công tác</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div id="excelTemplateData" style="display: none;">
                        ...
                        CB003,Lê Văn Cường,Nam,levcuong@gmail.com,0934567890,HV003,Cử nhân,Chuyên viên,Quản trị hệ
                        thống,DV003,Phòng CNTT,BC003,Bằng ĐH,TH003,Khóa ATTT,2019-08-20,2022-12-31
                        CB004,Phạm Thị Dung,Nữ,phamtdung@gmail.com,0945678901,HV004,Cao học,Phó trưởng bộ môn,Quản lý đào
                        tạo,DV004,Bộ môn HTTT,BC004,Bằng ThS,TH004,Khóa QLGD,2017-03-10,
                        CB005,Hoàng Văn Em,Nam,hoangvanem@gmail.com,0956789012,HV005,Tiến sĩ khoa học,Trưởng bộ môn,Nghiên
                        cứu khoa học,DV005,Bộ môn KHMT,BC005,Bằng TSKH,TH005,Khóa NCKH,2015-09-01,
                    </div>
                </div>
...
@section('custom-js')
    ...
    <script>
        ...
        function downloadTemplate() {
            try {
                // Lấy dữ liệu mẫu từ thẻ div
                let templateData = document.getElementById('excelTemplateData').innerText;
                let rows = templateData.trim().split('\n');
                ...
                XLSX.utils.book_append_sheet(workbook, worksheet, "DanhSachCanBo");

                // Tải xuống file Excel
                XLSX.writeFile(workbook, "canbo_template.xlsx");
                ...
                // Phương pháp thay thế: Tạo CSV nếu SheetJS không hoạt động
                let templateData = document.getElementById('excelTemplateData').innerText;
                let blob = new Blob([templateData], {
