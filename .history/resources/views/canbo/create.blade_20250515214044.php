                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control @error('MaHV') is-invalid @enderror" id="MaHV"
                                                        ...
                                                        @endforeach
                                                        <option value="new">+ Thêm học vị mới</option>
                                                    </select>
                                                    @error('MaHV')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                        ...
                                        <div class="row hv-new-fields" style="display: none;">
                                            <div class="col-md-6 mb-3">
                                                <label for="TenHocVi" class="form-label">Tên học vị mới</label>
                                                <input type="text" class="form-control" id="TenHocVi" name="TenHocVi" placeholder="Nhập tên học vị mới">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3 cv-new-fields" style="display: none;">
                                                <label for="TenChucVuNew" class="form-label">Chức vụ mới</label>
                                                <input type="text" class="form-control" id="TenChucVuNew" placeholder="Nhập tên chức vụ mới">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3 dv-new-fields" style="display: none;">
                                                <label for="TenDVHienTai" class="form-label">Tên đơn vị mới</label>
                                                <input type="text" class="form-control" id="TenDVHienTai" name="TenDVHienTai" placeholder="Nhập tên đơn vị mới">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-control @error('MaBang') is-invalid @enderror" id="MaBang"
                                                    ...
                                                    @endforeach
                                                    <option value="new">+ Thêm bằng cấp mới</option>
                                                </select>
                                                @error('MaBang')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3 bc-new-fields" style="display: none;">
                                                <label for="TenBang" class="form-label">Tên bằng cấp mới</label>
                                                <input type="text" class="form-control" id="TenBang" name="TenBang" placeholder="Nhập tên bằng cấp mới">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-control @error('MaTapHuan') is-invalid @enderror" id="MaTapHuan"
                                                    ...
                                                    @endforeach
                                                    <option value="new">+ Thêm khóa tập huấn mới</option>
                                                </select>
                                                @error('MaTapHuan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3 th-new-fields" style="display: none;">
                                                <label for="TenKhoaTapHuan" class="form-label">Tên khóa tập huấn mới</label>
                                                <input type="text" class="form-control" id="TenKhoaTapHuan" name="TenKhoaTapHuan" placeholder="Nhập tên khóa tập huấn mới">
                                            </div>
                                        </div>
