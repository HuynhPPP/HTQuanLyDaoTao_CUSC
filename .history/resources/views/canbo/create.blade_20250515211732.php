                        ...
                        <div class="card-body">
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-primary text-white">
                                    <h6 class="mb-0">Import danh sách cán bộ từ file Excel</h6>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-info">
                                        <h6 class="font-weight-bold">Hướng dẫn import file Excel:</h6>
                                        <ol>
                                            <li>Tải <a href="#" class="alert-link" onclick="copyExcelTemplate(); return false;">mẫu file Excel</a> để nhập dữ liệu (click vào đây để xem cấu trúc)</li>
...
<script>
    ...
    // Hiển thị mẫu Excel khi click vào link
    function copyExcelTemplate() {
        let templateData = document.getElementById('excelTemplateData').innerText;
        
        // Tạo modal hiển thị dữ liệu mẫu
        let modal = $('<div class="modal fade" tabindex="-1" role="dialog">')
            .append($('<div class="modal-dialog modal-lg" role="document">')
                .append($('<div class="modal-content">')
                    .append($('<div class="modal-header">')
                        .append($('<h5 class="modal-title">Mẫu dữ liệu Excel</h5>'))
                        .append($('<button type="button" class="close" data-dismiss="modal" aria-label="Close">')
                            .append($('<span aria-hidden="true">&times;</span>')))
                    )
                    .append($('<div class="modal-body">')
                        .append($('<div class="alert alert-info">Đây là dữ liệu mẫu, hãy sao chép và dán vào file Excel của bạn.</div>'))
                        .append($('<pre style="white-space: pre-wrap; border: 1px solid #ccc; padding: 10px; background-color: #f8f9fa;">')
                            .text(templateData)
                        )
                    )
                    .append($('<div class="modal-footer">')
                        .append($('<button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>'))
                        .append($('<button type="button" class="btn btn-primary" onclick="copyTemplateToClipboard()">Sao chép</button>'))
                    )
                )
            );
    ...
    function copyTemplateToClipboard() {
        ...
        navigator.clipboard.writeText(templateData).then(() => {
            alert('Đã sao chép dữ liệu mẫu vào clipboard!');
        }).catch(err => {
