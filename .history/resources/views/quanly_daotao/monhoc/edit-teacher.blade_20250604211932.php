        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('monhoc.update-teacher', ['tenMH' => $monhoc->TenMH, 'maGV' => $currentTeacher->MaGV]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('NgayBatDau') is-invalid @enderror" 
                                       ...
                                       value="{{ old('NgayBatDau', optional($currentTeacher->pivot)->NgayBatDau) }}">
                                @error('NgayBatDau')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('NgayKetThuc') is-invalid @enderror" 
                                       ...
                                       value="{{ old('NgayKetThuc', optional($currentTeacher->pivot)->NgayKetThuc) }}">
                                @error('NgayKetThuc')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="GhiChu" name="GhiChu" rows="3">{{ old('GhiChu', optional($currentTeacher->pivot)->GhiChu) }}</textarea>
                            </div>
