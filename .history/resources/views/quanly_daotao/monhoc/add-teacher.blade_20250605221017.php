    ...
    <div class="section">
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                        ...
                        <form action="{{ route('monhoc.store-teacher', $monhoc->MaMH) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Lớp Học</label>
                                        <select name="MaLop" class="form-control @error('MaLop') is-invalid @enderror">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h5 class="mb-0">Các phân công giảng dạy hiện tại</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $giangVien->pivot->MaLop }}</td>
                                        <td>{{ $giangVien->pivot->NgayBatDau ?? 'Chưa xác định' }}</td>
                                        <td>{{ $giangVien->pivot->NgayKetThuc ?? 'Chưa xác định' }}</td>
                                        <td>{{ $giangVien->pivot->GhiChu ?? 'Không có' }}</td>
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <form action="{{ route('monhoc.remove-teacher', ['MaMH' => $monhoc->MaMH, 'maGV' => $giangVien->MaGV]) }}" 
                                                      method="POST" 
                                                      class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
