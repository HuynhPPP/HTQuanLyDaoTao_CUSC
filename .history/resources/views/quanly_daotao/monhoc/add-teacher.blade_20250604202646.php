...
@section('main-content')
    <div class="section">
        <div class="section-header">
            <h1>Phân Công Giảng Viên Cho Môn Học {{ $monhoc->TenMH }}</h1>
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('monhoc.store-teacher', $monhoc->TenMH) }}" method="POST">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('monhoc.index', $monhoc->TenMH) }}" class="btn btn-secondary">
