                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right p-2"
                                                            ...
                                                            @foreach ($monhoc->giangViens->groupBy('MaGV') as $maGV => $assignments)
                                                                @php
                                                                    $gv = $assignments->first();
                                                                    $classes = $assignments->pluck('pivot.MaLop')->unique();
                                                                @endphp
                                        
                                                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                                                    <div>
                                                                        {{-- <div class="d-flex align-items-center">
                                                                            <strong class="mr-2">{{ $gv->HoTenGV }}</strong>
                                                                    ...
                                                                    <div class="btn-group-vertical btn-group-sm" role="group">
                                                                        <a href="{{ route('monhoc.edit-teacher', ['MaMH' => $monhoc->MaMH, 'maGV' => $maGV]) }}"
                                                                            class="btn btn-warning mb-1" data-toggle="tooltip"
                                                                        ...
                                                                        <form
                                                                            ...
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                                                                class="btn btn-danger remove-teacher-btn w-100" 
                                                                                data-toggle="tooltip" 
                                                                                title="Xoá phân công">
                                                                                <i class="fas fa-trash"></i>
                                                                            </button>
