        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4>Danh sách khoá đào tạo</h4>
                    <div class="card-header-action">
                        <a href="{{ route('khoadaotao.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('khoadaotao.destroy', $kdt->TenKhoaDaoTao) }}"
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger delete-khoadaotao"><i class="fas fa-trash"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
...
@section('custom-js')
    <script>
        $(document).ready(function() {
            $(document).on('click', '.delete-khoadaotao', function(e) {
                e.preventDefault();
