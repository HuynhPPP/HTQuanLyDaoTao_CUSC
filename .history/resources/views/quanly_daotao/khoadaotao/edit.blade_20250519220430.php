                ...
                <div class="card-body">
                    <form action="{{ route('khoadaotao.update', $khoadaotao->TenKhoaDaoTao) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="TenKhoaDaoTao"
                                class="form-control @error('TenKhoaDaoTao') is-invalid @enderror"
                                value="{{ old('TenKhoaDaoTao', $khoadaotao->TenKhoaDaoTao) }}">
                            @error('TenKhoaDaoTao')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ThoiGianDaoTao"
                                class="form-control @error('ThoiGianDaoTao') is-invalid @enderror"
                                value="{{ old('ThoiGianDaoTao', $khoadaotao->ThoiGianDaoTao) }}">
