                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('khoadaotao.edit', $kdt->TenKhoaDaoTao) }}" class="btn btn-warning">Sửa</a>
                                        <form action="{{ route('khoadaotao.destroy', $kdt->TenKhoaDaoTao) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
