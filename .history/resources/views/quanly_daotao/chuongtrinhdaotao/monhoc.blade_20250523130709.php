                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('TenMH') is-invalid @enderror" id="TenMH" name="TenMH">
                            ...
                            <tbody>
                                @foreach ($monHocDaGan as $index => $monHoc)
                                    <tr>
                                        ...
                                        <td>{{ $monHoc->TenMH }}</td>
                                        <td>
                                            <form action="{{ route('chuongtrinh.monhoc.destroy', [$chuongTrinh->MaChuongTrinh, $monHoc->TenMH]) }}" 
