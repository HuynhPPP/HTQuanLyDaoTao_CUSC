                    ...
                    <form action="{{ route('chuongtrinh.store') }}" method="POST" id="chuongTrinhForm">
                        ...
                        <div id="xeploai-wrapper">
                            <div class="row xep-loai-row mb-3">
                                ...
                                <div class="col-md-4">
                                    <input type="number" step="0.1" name="xeploai[0][DiemTu]" class="form-control" placeholder="% tối thiểu" min="0" max="10">
                                </div>
                                <div class="col-md-4">
                                    <input type="number" step="0.1" name="xeploai[0][DiemDen]" class="form-control" placeholder="% tối đa" min="0" max="10">
                                </div>
                            </div>
                        </div>
