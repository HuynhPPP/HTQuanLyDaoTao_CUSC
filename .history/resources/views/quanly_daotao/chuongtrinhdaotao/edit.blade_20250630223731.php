                            ...
                            <div class="card-body" id="danh-gia-wrapper">
                                    ...
                                    <div class="row danh-gia-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-1 d-flex align-items-center">
                                            <button type="button" class="btn btn-danger btn-sm remove-row"
                                                onclick="$(this).closest('.danh-gia-row').remove()">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="danhgia[{{ $index }}][selected]"
                                ...
                                @empty
                                    <div class="row danh-gia-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="danhgia[0][selected]" value="0"
                            ...
                            <div class="card-body" id="xeploai-wrapper">
                                ...
                                @forelse($tieuChiXepLoai as $index => $xepLoai)
                                    <div class="row xep-loai-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="xeploai[{{ $index }}][selected]"
                                                    value="{{ $index }}" class="form-check-input">
                                            </div>
                                        </div>
                                    </div>
                                @empty
                                    <div class="row xep-loai-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="xeploai[0][selected]" value="0"
                                                    class="form-check-input">
                                            </div>
                                        </div>
                                    </div>
