                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="MaMH">Chọn môn học <span class="text-danger">*</span></label>
                                    <select class="form-control @error('MaMH') is-invalid @enderror select2" id="MaMH"
                                        name="MaMH[]" multiple="">
                        ...
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                @foreach ($monHocDaGan as $index => $monHoc)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $monHoc->monHoc->TenMH }}</td>
                                        <td>
                                            @if($monHoc->monHoc->TietLT) Lý thuyết @endif
                                            @if($monHoc->monHoc->TietTH) Thực hành @endif
                                            @if($monHoc->monHoc->TietLTvaTH) Lý thuyết và Thực hành @endif
                                        </td>
                                        <td>
                                            <form
                                                action="{{ route('chuongtrinh.monhoc.destroy', [$chuongTrinh->MaChuongTrinh, $monHoc->MaMH]) }}"
