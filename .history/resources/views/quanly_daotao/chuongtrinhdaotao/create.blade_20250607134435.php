...
<div id="danh-gia-wrapper">
    <div class="row danh-gia-row mb-3">
        ...
        <div class="col-md-2">
            <input type="number" name="danhgia[0][TiLePhanTram]" class="form-control" placeholder="%">
        </div>
        <div class="col-md-2">
            <input type="number" name="danhgia[0][SoBaiThi]" class="form-control" placeholder="Số bài thi">
        </div>
        <div class="col-md-2">
            <input type="number" name="danhgia[0][DiemMoiBai]" class="form-control" placeholder="Điểm/mỗi bài">
        </div>
        <div class="col-md-2">
            <input type="number" name="danhgia[0][ThoiGian]" class="form-control" placeholder="Thời gian">
        </div>
        <div class="col-md-1">
...
<div id="xeploai-wrapper">
    <div class="row xep-loai-row mb-3">
        ...
        <div class="col-md-4">
            <input type="number" step="0.1" name="xeploai[0][DiemTu]" class="form-control" placeholder="Điểm từ">
        </div>
        <div class="col-md-4">
            <input type="number" step="0.1" name="xeploai[0][DiemDen]" class="form-control" placeholder="Điểm đến">
        </div>
    </div>
</div>
