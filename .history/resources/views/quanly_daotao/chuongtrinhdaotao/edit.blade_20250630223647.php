                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">
                                    ...
                                    <small class="text-muted ml-2" data-toggle="tooltip" title="Xác định các phương thức và trọng số đánh giá">
                                    ...
                                    <div class="row danh-gia-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" 
                                                    name="danhgia[{{ $index }}][TiLePhanTram]" 
                                                    id="TiLePhanTram_{{ $index }}"
                                                    class="form-control" 
                                                    placeholder="%" 
                                                    value="{{ $danhGia->TiLePhanTram }}" 
                                                    min="0" 
                                                    max="100" 
                                                    required>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" 
                                                    name="danhgia[{{ $index }}][SoBaiThi]" 
                                                    id="SoBaiThi_{{ $index }}"
                                                    class="form-control" 
                                                    placeholder="Số bài thi" 
                                                    value="{{ $danhGia->SoBaiThi }}" 
                                                    min="0">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" 
                                                    name="danhgia[{{ $index }}][DiemMoiBai]" 
                                                    id="DiemMoiBai_{{ $index }}"
                                                    class="form-control" 
                                                    placeholder="Điểm/mỗi bài" 
                                                    value="{{ $danhGia->DiemMoiBai }}" 
                                                    step="0.1" 
                                                    min="0">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" 
                                                        name="danhgia[{{ $index }}][ThoiGian]" 
                                                        id="ThoiGian_{{ $index }}"
                                                        class="form-control" 
                                                        placeholder="Thời gian" 
                                                        value="{{ $danhGia->ThoiGian }}" 
                                                        min="0">
                                        ...
                                        <div class="col-md-1 d-flex align-items-center">
                                            <button type="button" class="btn btn-danger btn-sm remove-row" onclick="$(this).closest('.danh-gia-row').remove()">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="danhgia[{{ $index }}][selected]" value="{{ $index }}" class="form-check-input">
                                            </div>
                                        </div>
                                    </div>
                                @empty
                                    <div class="row danh-gia-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Tỉ lệ (%)</label>
                                                <input type="number" name="danhgia[0][TiLePhanTram]" class="form-control" placeholder="%" min="0" max="100" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="danhgia[0][selected]" value="0" class="form-check-input">
                                            </div>
                                        </div>
                                    </div>
                                @endforelse
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">
                                    ...
                                    <small class="text-muted ml-2" data-toggle="tooltip" title="Xác định ngưỡng điểm cho từng xếp loại">
                                        <i class="fas fa-info-circle"></i>
                                    </small>
                                </h5>
                                    ...
                                    <div class="row xep-loai-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" 
                                                    name="xeploai[{{ $index }}][DiemTu]" 
                                                    id="DiemTu_{{ $index }}"
                                                    class="form-control" 
                                                    placeholder="% tối thiểu" 
                                                    value="{{ $xepLoai->DiemTu }}"
                                                    min="0" 
                                                    max="100" 
                                                    required>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" 
                                                    name="xeploai[{{ $index }}][DiemDen]" 
                                                    id="DiemDen_{{ $index }}"
                                                    class="form-control" 
                                                    placeholder="% tối đa" 
                                                    value="{{ $xepLoai->DiemDen }}"
                                                    min="0" 
                                                    max="100" 
                                                    required>
                                            </div>
                                        ...
                                        <div class="col-md-1 d-flex align-items-center">
                                            <button type="button" class="btn btn-danger btn-sm remove-row" onclick="$(this).closest('.xep-loai-row').remove()">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="xeploai[{{ $index }}][selected]" value="{{ $index }}" class="form-check-input">
                                            </div>
                                        </div>
                                    </div>
                                @empty
                                    <div class="row xep-loai-row mb-3 border-bottom pb-3">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <input type="checkbox" name="xeploai[0][selected]" value="0" class="form-check-input">
                                            </div>
                                        </div>
                                    </div>
                                @endforelse
