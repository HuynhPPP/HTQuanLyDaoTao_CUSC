                        ...
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $chuongTrinh->NgayTrienKhaiPB ? date('d/m/Y', strtotime($chuongTrinh->NgayTrienKhaiPB)) : 'Chưa xác định' }}</td>
                                    <td>{{ $chuongTrinh->TenKhoaDaoTao }}</td>
                                    <td>{{ $chuongTrinh->ThoiGianDaoTao }}</td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('chuongtrinh.edit', $chuongTrinh->MaChuongTrinh) }}" class="btn btn-warning btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('chuongtrinh.destroy', $chuongTrinh->MaChuongTrinh) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
