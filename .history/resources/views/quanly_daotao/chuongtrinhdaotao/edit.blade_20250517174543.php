                        ...
                        <form action="{{ route('chuongtrinh.update', $chuongTrinh->MaChuongTrinh) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('TenPhong') is-invalid @enderror" id="TenPhong"
                                        name="TenPhong">
                                        <option value="">-- Chọn phòng --</option>
                                        @foreach ($khoadaotaos as $khoadaotao)
                                            <option value="{{ $khoadaotao->TenPhong }}"
                                                {{ old('TenPhong', $danhsachphong->TenPhong) == $phong->TenPhong ? 'selected' : '' }}>
