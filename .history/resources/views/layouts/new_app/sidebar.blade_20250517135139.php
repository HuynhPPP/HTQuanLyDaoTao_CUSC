    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @php
                ...
                $dropdownActive = $nhanSuActive || $donViLopActive || $hanhChinhActive;
            @endphp
            <li class="dropdown {{ $dropdownActive ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-server"></i> <span>Dữ liệu hệ thống</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown {{ $hanhChinhActive ? 'active' : '' }}">
                        <a href="#" class="nav-link has-dropdown">Quản lý chương trình đào tạo</a>
                        <ul class="dropdown-menu">
                            <li class="{{ request()->routeIs('taphuan.*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('taphuan.index') }}">Chương trình đào tạo</a>
                            </li>
                            <li class="{{ request()->routeIs('bangcapcanbo.*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('bangcapcanbo.index') }}">Bằng Cấp</a>
                            </li>
