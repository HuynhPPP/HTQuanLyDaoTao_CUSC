<div class="main-sidebar sidebar-style-2" style="position: absolute; top: 0; left: 0; height: 700px;">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown {{ $dropdownActive ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-server"></i></i> <span>Dữ liệu hệ
                        thống</span></a>
