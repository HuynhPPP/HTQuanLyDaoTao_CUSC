                ...
                $("#modal-addTime").fireModal({
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            submit: false, // Để tự xử lý submit
                            handler: function(modal) {
                                // Tìm form trong modal
                                const form = modal.find('#absenceForm');
            
                                swal({
                                    title: 'Bạn có chắc chắn muốn lưu ngày nghỉ?',
                                    text: 'Thông tin sẽ được gửi và không thể hoàn tác.',
                                    icon: 'warning',
                                    buttons: ['Hủy', 'Lưu'],
                                    dangerMode: true,
                                }).then((willSave) => {
