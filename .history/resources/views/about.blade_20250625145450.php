        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <h1 class="text-primary fw-bold">Hệ thống quản lý đào tạo</h1>
                    <p class="lead mt-3">
                        Trung tâm Đào tạo CUSC là đơn vị tiên phong trong lĩnh vực đào tạo Công nghệ Thông tin tại Đồng bằng
                        Sông Cửu Long, với sứ mệnh cung cấp nguồn nhân lực chất lượng cao, đáp ứng nhu cầu phát triển của xã
                        hội
                        hiện đại.
                    </p>
                </div>
                ...
                <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item">
                            <img class="d-block w-100 h-100" src="{{ asset('images/banner_cusc_2.png') }}"
                                alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100 h-100" src="{{ asset('images/banner_cusc_1.png') }}"
                                alt="Second slide">
                        </div>
            ...
            <ul class="timeline">
                <li class="timeline-item">
                    ...
                    Trường Đại học Cần Thơ làm lễ ký kết hợp tác với Aptech thành lập Trung tâm Đào tạo Lập trình viên Quốc
                    tế
                    MeKong Delta - Aptech.
                </li>
                <li class="timeline-item">
                ...
                <li class="timeline-item">
                    ...
                    Chương trình Quản trị mạng ACNA được chính thức triển khai, đây là khoá học thứ 2 được Việt hoá, giúp
                    nhiều
                ...
                <li class="timeline-item">
                    ...
                    Được sự chấp thuận của Bộ GD&ĐT và trường Đại học Cần Thơ, CUSC nâng tầm đào tạo lên hệ Cao đẳng CNTT
                    chính
                ...
                <li class="timeline-item">
                    ...
                    Đạt danh hiệu Sao Khuê hạng 4 sao cho dịch vụ đào tạo CNTT. Nhận hai danh hiệu "Đơn vị đào tạo xuất sắc"
                    và
                    "Đơn vị đạt chất lượng đào tạo xuất sắc nhất" do Aptech Ấn Độ trao tặng.
                </li>
                <li class="timeline-item">
                    <span class="badge bg-warning me-2">2015</span>
                    Đạt danh hiệu Sao Khuê hạng 4 sao cho dịch vụ đào tạo Ứng dụng CNTT trong đổi mới phương pháp giảng dạy
                    và
