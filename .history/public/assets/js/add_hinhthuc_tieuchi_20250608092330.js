    ...
    $('#themTieuChiXepLoai').click(function () {
        const newRow = `
            <div class="row xep-loai-row mb-3">
                ...
                <div class="col-md-4">
                    <input type="number" step="0.1" name="xeploai[${xepLoaiIndex}][DiemTu]" class="form-control" placeholder="% tối thiểu" min="0" max="10">
                </div>
                <div class="col-md-4">
                    <input type="number" step="0.1" name="xeploai[${xepLoaiIndex}][DiemDen]" class="form-control" placeholder="% tối đa" min="0" max="10">
                </div>
