    ...
    public function registerEvents(): array
    {
        return [
            BeforeSheet::class => function (BeforeSheet $event) {
                ...
                $canBoList = $lichThi->canBos->map(fn($gv) => $gv->giaoVien->HoTenGV)->values();
                ...
                $sheet->mergeCells('A6:E6')->setCellValue('A6', 'Môn: ' . $lichThi->monHoc->TenMH . ' | Lớp: ' . $lichThi->MaLop);
