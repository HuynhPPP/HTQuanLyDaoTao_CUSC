...
class lophoc extends Model
{
    ...
    {
        return $this->belongsToMany(GiaoVien::class, 'giangday', 'MaLop', 'MaGV')
            ->withPivot('NgayBatDau', 'NgayKetThuc', 'GhiChu')
            ->withTimestamps();
    }

    public function reports()
    {
        return $this->hasMany(ThongKeBaoCaoDoAn::class, 'class_id', 'MaLop');
    }
}
