...
class WordParserService
{
    ...
    {
        // Hàm này không còn cần thiết nếu bạn đã sử dụng firstOrCreate trực tiếp
        // Tuy nhiên, nếu bạn muốn giữ nó cho mục đích khác, hãy đảm bảo tìm kiếm chính xác
        $gv = \App\Models\giaovien::where('HoTenGV', $hoTen)->first();
        return $gv?->MaGV;
    }
}