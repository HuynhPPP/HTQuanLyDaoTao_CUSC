...
class PhuTrachController extends Controller
{
    public function index()
    {
        ...
        return view('quanly_canbo.phutrach.index', compact('phuTrachs'));
    }

    public function create()
    {
        return view('quanly_canbo.phutrach.create');
    }
    ...
    public function edit($congViecPhuTrach)
    {
        ...
        return view('quanly_canbo.phutrach.edit', compact('phuTrach'));
    }
