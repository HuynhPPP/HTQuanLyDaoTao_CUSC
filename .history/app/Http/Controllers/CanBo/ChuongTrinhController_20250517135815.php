...
class ChuongTrinhController extends Controller
{
    ...
    {
        $chuongTrinhs = ChuongTrinh::paginate(10);
        return view('quanly_canbo.chuongtrinh.index', compact('chuongTrinhs'));
    }

    public function create()
    {
        return view('quanly_canbo.chuongtrinh.create');
    }
    ...
    public function edit($maChuongTrinh)
    {
        ...
        return view('quanly_canbo.chuongtrinh.edit', compact('chuongTrinh'));
    }
