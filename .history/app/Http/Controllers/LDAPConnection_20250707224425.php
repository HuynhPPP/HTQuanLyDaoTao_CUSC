    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            if (!$dbUser) {
                ...
                return back()->with('error', 'Đã xảy ra lỗi khi đăng nhập. Vui lòng thử lại.');
            }

            if (!$dbUser->is_active) {
                return back()->withErrors(['login' => 'Tài khoản của bạn đã bị khóa. Vui lòng liên hệ quản trị viên.'])->withInput();
            }
