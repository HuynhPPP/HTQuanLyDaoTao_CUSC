...
class ThongKeBaoCaoDoAnController extends Controller
{
    ...
    public function uploadFile(Request $request)
    {
        ...
        try {
            ...
            $class = lophoc::firstOrCreate(['name' => $class_name]);
            $instructor = giaovien::firstOrCreate(['full_name' => $instructor_name]);
            $reviewer = giaovien::firstOrCreate(['full_name' => $reviewer_name]);
