    ...
    public function deleteSchedule($TenTKB)
    {
        if (session()->has('user')) {
            ...
            if ($schedule) {
                ...
                danhsachphong::where('MaLop', $schedule->MaLop)
                    ->where('NgaySuDung', $schedule->NgayHoc)
                    ->delete();
    ...
    public function saveholiday(Request $request, $TenTKB)
    {
        if (session()->has('user')) {
            ...
            try {
                ...
                return redirect()->route('schedule.detail', ['TenTKB' => $TenTKB])
    ...
    public function EditTKB(Request $request, $TenTKB)
    {
        if (session()->has('user')) {
            ...
            try {
                ...
                $phongRecords = danhsachphong::where('MaLop', $schedule->MaLop)->get();
    ...
    public function saveTimeSlot(Request $request, $TenTKB)
    {
        if (session()->has('user')) {
            try {
                ...
                $khungGio = khunggio::updateOrCreate(
