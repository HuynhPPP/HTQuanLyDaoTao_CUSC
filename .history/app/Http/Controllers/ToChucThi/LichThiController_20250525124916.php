...
class LichThiController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        // Tách KhungGio: "13:00 - 13:40"
        [$gioBatDau, $gioKetThuc] = explode(' - ', $lichThi->KhungGio);

        // Tính thời lượng phút
        $carbonBatDau = \Carbon\Carbon::createFromFormat('H:i', $gioBatDau);
        $carbonKetThuc = \Carbon\Carbon::createFromFormat('H:i', $gioKetThuc);
        $thoiLuong = $carbonKetThuc->diffInMinutes($carbonBatDau);

        // Gán vào lichThi để view hiển thị
