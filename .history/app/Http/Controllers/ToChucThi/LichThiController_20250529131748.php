...
class LichThiController extends Controller
{
    ...
    private function validateLichThi(Request $request)
    {
        return $request->validate([
            ...
            'LanThi.required' => 'Vui lòng nhập lần thi.',
            'LanThi.integer' => 'Lần thi phải là số nguyên.',
    ...
    public function danhSachSinhVienTheoLop($maLop)
    {
        ...
        return view('tochucthi.lichthi.danhsach_sinhvien_lop', [
            'lop' => $lop,
            'danhSachSinhVien' => $danhSachSinhVien,
            'danhSachLichThi' => $danhSachLichThi
        ]);
    }

    // Phương thức xuất Excel danh sách sinh viên
    public function xuatDanhSachSinhVienExcel($maLop)
    {
        return Excel::download(new DanhSachSinhVienLopExport($maLop), "danh_sach_sinh_vien_lop_{$maLop}.xlsx");
    }
}
