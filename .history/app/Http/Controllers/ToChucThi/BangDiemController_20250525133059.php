...
{
    // Lấy danh sách lớp và môn học từ DB (hoặc hardcode nếu chưa có DB)
    $dsLop = ['L01', 'L02', 'L03'];
    $dsMon = ['TinHoc', 'Toan', 'Ly'];

    return view('bangdiem.chon', compact('dsLop', 'dsMon'));
}
...
public function xemBangDiem(Request $request)
{
    ...
    // Chuyển hướng đến route bangdiem.show
