...
class BangDiemController extends Controller
{
    ...
    public function nhapDiemChiTiet(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'DiemLyThuyet' => 'required|numeric|min:0|max:20',
            'DiemThucHanh' => 'required|numeric|min:0|max:20',
    ...
    public function luuDiemChoLop(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'diemThi.*.DiemLyThuyet' => 'required|numeric|min:0|max:20',
            'diemThi.*.DiemThucHanh' => 'required|numeric|min:0|max:20',
                ...
                $diemThi = DiemThi::updateOrCreate(
                    ...
                    [
                        ...
                        'TrangThai' => 
                            (($diemSV['DiemLyThuyet'] * 0.5) + 
                            ($diemSV['DiemThucHanh'] * 0.3) + 
                            ($diemSV['DiemDuAn'] * 0.2)) >= 5.0 ? 'DatChuan' : 'ChuaDatChuan'
                    ]
                );
