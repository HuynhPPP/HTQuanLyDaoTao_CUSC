    ...
    if ($request->hasFile('file')) {
        ...
        if ($request->has('diem') && is_array($request->diem)) {
            ...
            foreach ($request->diem as $maSV => $diem) {
                ...
                logger("Processing: MaSV=$maSV, TenMH=$tenMH, LanThi=$lanThi, Diem=$diem");
                ...
                if ($existingRecord) {
                    ...
                    logger("Updated existing record: MaSV=$maSV, LanThi=$lanThi");
                } else {
                    // Tạo record mới
                    DiemThi::create([
                        'MaSV' => $maSV,
                    ...
                    logger("Created new record: MaSV=$maSV, LanThi=$lanThi");
                }
            }
        }
    }
