...
class LapBangDiemThiController extends Controller
{
    ...
    // Xuất Excel bảng điểm môn học
    public function xuatBangDiem($maLichThi)
    {
        $lichThi = LichThi::findOrFail($maLichThi);
        return Excel::download(
            new \App\Exports\BangDiemMonHocExport($maLichThi), 
            "bang_diem_{$lichThi->TenMH}_{$lichThi->MaLop}_{$lichThi->NgayThi}.xlsx"
        );
    }
    ...
    public function xuatBangDiemChiTiet($maLop, $maMH)
    {
        ...
        return \Excel::download(
            ...
            "bang_diem_chi_tiet_{$maLop}_{$maMH}.xlsx"
        );
    }
}
