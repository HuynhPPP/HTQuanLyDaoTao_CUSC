...
class MonHocController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'MaHTDanhGia' => 'nullable|exists:hinhthucdanhgia,MaHTDanhGia'
        ], [
    ...
    public function edit($tenMH)
    {
        ...
        $hinhthucdanhgias = HinhThucDanhGia::all();
        return view('quanly_daotao.monhoc.edit', compact('monhoc', 'hinhthucdanhgias'));
    }
    ...
    public function update(Request $request, $tenMH)
    {
        $validator = Validator::make($request->all(), [
            ...
            'MaMH.required' => 'Mã môn học là bắt buộc.',
            'MaMH.max' => 'Mã môn học không được vượt quá 12 ký tự.',
            'GioGoc.integer' => 'Giờ gốc phải là số nguyên.',
            'GioTrienKhai.integer' => 'Giờ triển khai phải là số nguyên.',
            'TietLT.boolean' => 'Tiết lý thuyết phải là giá trị đúng/sai.',
            'TietTH.boolean' => 'Tiết thực hành phải là giá trị đúng/sai.',
            'TietLTvaTH.boolean' => 'Tiết LT và TH phải là giá trị đúng/sai.',
            'MaHTDanhGia.exists' => 'Hình thức đánh giá không hợp lệ.'
        ]);
