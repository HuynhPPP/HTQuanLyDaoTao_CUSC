...
class ThongKeDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Thống kê giáo viên
        $thongKeGiaoVien = $this->thongKeService->thongKeSinhVien();
        $tongGiaoVien = $thongKeSinhVien->sum('tong_so_luong');
        $tongNamGV = $thongKeSinhVien->sum('nam');
        $tongNuGV = $thongKeSinhVien->sum('nu');
