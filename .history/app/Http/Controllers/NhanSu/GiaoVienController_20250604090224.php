...
class GiaoVienController extends Controller
{
    ...
    public function changePassword(Request $request)
    {
        ...
        $username = session('id');
        $ldapAccount = LdapAccount::where('MaTaiKhoan', $username)->first();
        ...
        $checkCurrentPassword = $ldapConnection->checkPassword($username, $request->current_password);
        ...
        try {
            // Thay đổi mật khẩu qua LDAP
            $changePasswordResult = $ldapConnection->changePassword(
                $username, 
            ...
            if ($changePasswordResult) {
                ...
                $ldapAccount->initial_password = bcrypt($request->new_password);
                $ldapAccount->save();
