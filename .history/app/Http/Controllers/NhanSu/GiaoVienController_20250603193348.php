            ...
            foreach ($giaoViens as $giaoVien) {
                ...
                try {
                    ...
                    $entry = [
                        ...
                        'displayName' => [iconv('UTF-8', 'ISO-8859-1//TRANSLIT', $giaoVien->HoTenGV)],
                        'mail' => [$fullEmail],

                        // Xử lý tên riêng và họ
                        'givenName' => [iconv('UTF-8', 'ISO-8859-1//TRANSLIT', explode(' ', $giaoVien->HoTenGV)[0])],
                        'sn' => [iconv('UTF-8', 'ISO-8859-1//TRANSLIT', array_slice(explode(' ', $giaoVien->HoTenGV), -1)[0])],
                        'initials' => [substr($giaoVien->HoTenGV, 0, 1)]
                    ];
