            ...
            foreach ($giaoViens as $giaoVien) {
                ...
                try {
                    ...
                    $entry = [
                        ...
                        'displayName' => [$giaoVien->HoTen],
                        'mail' => [$fullEmail],

                        // Thêm các thuộc tính để tránh vi phạm ràng buộc
                        'givenName' => [explode(' ', $giaoVien->HoTen)[0]],
                        'sn' => [array_slice(explode(' ', $giaoVien->HoTen), -1)[0]],
                        'initials' => [substr($giaoVien->HoTen, 0, 1)]
                    ];
                    ...
                    $ldapAccount = LdapAccount::create([
                        'MaTaiKhoan' => $giaoVien->MaSV,
                        'username' => $sanitizedEmail,
                        'email' => $fullEmail,
                        'full_name' => $giaoVien->HoTen,
