...
class GiaoVienController extends Controller
{
    ...
    public function guiThongTinTaiKhoanNhieu(Request $request)
{
    ...
    foreach ($accountIds as $id) {
        try {
            ...
            if (!$user || !$user->Email) {
                $errorCount++;
                $errorDetails[] = "Không tìm thấy email cho tài khoản {$ldapAccount->MaTaiKhoan}";
                continue;
            }
            ...
            $errorCount++;
            $errorDetails[] = "Lỗi gửi email cho {$ldapAccount->MaTaiKhoan}: " . $e->getMessage();
    ...
    $message = "Gửi email thành công: $successCount, Lỗi: $errorCount";
