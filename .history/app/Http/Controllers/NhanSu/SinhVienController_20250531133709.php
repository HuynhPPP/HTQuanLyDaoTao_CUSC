...
class SinhVienController extends Controller
{
    ...
    public function dongBoTaiKhoanLDAP()
    {
        ...
        try {
            ...
            $sinhViens = SinhVien::whereDoesntHave('ldapAccount')->get();
            ...
            foreach ($sinhViens as $sinhVien) {
                ...
                try {
                    ...
                    if (!$addResult) {
                        $error = ldap_error($ds);
                        $errno = ldap_errno($ds);
                        throw new \Exception("Lỗi tạo user LDAP: $error (Mã lỗi: $errno)");
                    }
                    ...
                    $studentGroupDN = "CN=Students,CN=Users,{$ldapconfig['basedn']}";
                    ldap_mod_add($ds, $studentGroupDN, ['member' => $dn]);
    ...
    public function xuatDanhSachTaiKhoanMoi()
    {
        ...
        return view('quanly_nhansu.ldap.danh_sach_tai_khoan', compact('ldapAccounts'));
    }
