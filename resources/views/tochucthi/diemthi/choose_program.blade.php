...
<div class="section">
    <div class="section-header">
        <h1>Chọn Chương Trình Đào Tạo Để Lập Bảng Điểm Tổng</h1>
    </div>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('bang-diem-tong', ['maChuongTrinh' => '__maChuongTrinh__']) }}" method="GET" id="formChonChuongTrinh">
...
$(document).ready(function() {
    $('#maChuongTrinh').change(function() {
        ...
        var newAction = "{{ route('bang-diem-tong', ['maChuongTrinh' => '__maChuongTrinh__']) }}"
