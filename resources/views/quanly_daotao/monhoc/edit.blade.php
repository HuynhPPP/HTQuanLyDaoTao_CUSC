                    ...
                    <form action="{{ route('monhoc.update', $monhoc->MaMH) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="TietLT" name="TietLT"
                                            value="1" {{ old('TietLT', $monhoc->TietLT) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="TietTH" name="TietTH"
                                            value="1" {{ old('TietTH', $monhoc->TietTH) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="TietLTvaTH"
                                            name="TietLTvaTH" value="1"
