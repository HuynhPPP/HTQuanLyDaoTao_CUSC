    ...
    <div class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Thông tin chi tiết sinh viên</div>
            </div>
        </div>
        <div class="container">
                        ...
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ [
                                                    ...
                                                    'DaNghiHoc' => 'Đã nghỉ học',
                                                ][$sinhVien->TinhTrangHocTap] ?? 'Không xác định' }}
                                            </td>
                                        </tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                            <th style="width: 40%">Email cá nhân</th>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <h6 class="mb-3">Lớp học đã đăng ký</h6>
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Mã lớp</th>
                                        ...
                                        <tbody>
                                            @forelse($sinhVien->danhSachLop as $lop)
                                                <tr>
                                                    ...
                                                    <td>{{ $lop->lopHoc->loaidaotao->TenChuongTrinh }}</td>
                                                </tr>
                                            @empty
                                                <tr>
